...
bool Database::proc_56(::hyde::rt::Vec<Tup_i32> vec58, ::hyde::rt::Vec<Tup_i32> vec59, ::hyde::rt::Vec<Tup_i32> vec92, ::hyde::rt::Vec<Tup_i32> vec93, ::hyde::rt::Vec<Tup_i32> vec117, ::hyde::rt::Vec<Tup_i32> vec120) {
            ...
            if (find_64(v63)) {
              if (table_16.TryChangePresentToUnknown({true, v63})) {
                if (table_36.TryChangePresentToUnknown({v63})) {
                  mixed_30.TryChangePresentToUnknown({v63});
                }
              }
            }
          }
          for (uint32_t s67 = 0; s67 < table_12.NumRows(); ++s67) {
            ...
            if (find_70(v68, v69)) {
              if (table_26.TryChangePresentToUnknown({true, v69})) {
                pos_neg_50.TryChangePresentToUnknown({v69});
              }
            }
          }
          vec74.Add({true});
      ...
      if (table_42.TryChangePresentToUnknown({true, v76})) {
        if (__9.TryChangePresentToUnknown({true})) {
            ...
            if (true == v91) {
              if (table_12.TryChangePresentToUnknown({true, v90})) {
                if (table_26.TryChangePresentToUnknown({true, v90})) {
                  pos_neg_50.TryChangePresentToUnknown({v90});
                }
                if (table_33.TryChangePresentToUnknown({v90})) {
                  mixed_30.TryChangePresentToUnknown({v90});
                }
                both_pos_53.TryChangePresentToUnknown({v90});
              }
            }
          }
              ...
              if (!find_80(true)) {
                if (const auto ins3 = table_16.TryChangeAbsentOrUnknownToPresent({true, v78}); ins3.changed) {
                  ...
                  if (const auto ins4 = table_36.TryChangeAbsentOrUnknownToPresent({v78}); ins4.changed) {
                    mixed_30.TryChangeAbsentOrUnknownToPresent({v78});
                  }
                }
              }
            }
          ...
          for (uint32_t s83 = 0; s83 < table_12.NumRows(); ++s83) {
            ...
            if (find_70(v84, v85)) {
              if (!find_80(true)) {
                if (const auto ins5 = table_26.TryChangeAbsentOrUnknownToPresent({true, v85}); ins5.changed) {
                  if (ins5.added_row) {
                    idx_239.Add({v85}, ins5.id);
                  }
                  pos_neg_50.TryChangeAbsentOrUnknownToPresent({v85});
                }
              }
            }
          }
  ...
  for (auto [v95] : vec92) {
    if (const auto ins6 = table_23.TryChangeAbsentToPresent({v95}); ins6.changed) {
      if (const auto ins7 = table_46.TryChangeAbsentOrUnknownToPresent({true, v95}); ins7.changed) {
            ...
            if (find_64(v97)) {
              if (table_16.TryChangePresentToUnknown({true, v97})) {
                if (table_36.TryChangePresentToUnknown({v97})) {
                  mixed_30.TryChangePresentToUnknown({v97});
                }
              }
            }
          }
          for (uint32_t s99 = 0; s99 < table_12.NumRows(); ++s99) {
            ...
            if (find_70(v100, v101)) {
              if (table_26.TryChangePresentToUnknown({true, v101})) {
                pos_neg_50.TryChangePresentToUnknown({v101});
              }
            }
          }
          vec74.Add({true});
      ...
      if (table_46.TryChangePresentToUnknown({true, v104})) {
        if (__9.TryChangePresentToUnknown({true})) {
            ...
            if (true == v116) {
              if (table_12.TryChangePresentToUnknown({true, v115})) {
                if (table_26.TryChangePresentToUnknown({true, v115})) {
                  pos_neg_50.TryChangePresentToUnknown({v115});
                }
                if (table_33.TryChangePresentToUnknown({v115})) {
                  mixed_30.TryChangePresentToUnknown({v115});
                }
                both_pos_53.TryChangePresentToUnknown({v115});
              }
            }
          }
          for (uint32_t s105 = 0; s105 < table_39.NumRows(); ++s105) {
            ...
            if (find_64(v106)) {
              if (!find_80(true)) {
                if (const auto ins9 = table_16.TryChangeAbsentOrUnknownToPresent({true, v106}); ins9.changed) {
                  if (ins9.added_row) {
                    idx_188.Add({v106}, ins9.id);
                  }
                  if (const auto ins10 = table_36.TryChangeAbsentOrUnknownToPresent({v106}); ins10.changed) {
                    mixed_30.TryChangeAbsentOrUnknownToPresent({v106});
                  }
                }
              }
            }
          ...
          for (uint32_t s109 = 0; s109 < table_12.NumRows(); ++s109) {
            ...
            if (find_70(v110, v111)) {
              if (!find_80(true)) {
                if (const auto ins11 = table_26.TryChangeAbsentOrUnknownToPresent({true, v111}); ins11.changed) {
                  if (ins11.added_row) {
                    idx_239.Add({v111}, ins11.id);
                  }
                  pos_neg_50.TryChangeAbsentOrUnknownToPresent({v111});
                }
              }
            }
          }
  ...
  for (auto [v119] : vec117) {
    if (const auto ins12 = table_5.TryChangeAbsentToPresent({v119, true}); ins12.changed) {
      if (ins12.added_row) {
        idx_88.Add({true}, ins12.id);
      }
      vec74.Add({true});
    }
  }
  for (auto [v122] : vec120) {
    if (const auto ins13 = table_39.TryChangeAbsentToPresent({v122}); ins13.changed) {
      if (!find_80(true)) {
        if (const auto ins14 = table_16.TryChangeAbsentOrUnknownToPresent({true, v122}); ins14.changed) {
          if (ins14.added_row) {
            idx_188.Add({v122}, ins14.id);
          }
          if (const auto ins15 = table_36.TryChangeAbsentOrUnknownToPresent({v122}); ins15.changed) {
            mixed_30.TryChangeAbsentOrUnknownToPresent({v122});
          }
        }
      }
    }
  ...
  switch (table_12.State({v71, v72})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_12.TryChangeUnknownToAbsent({v71, v72})) {
        if (find_313(v71, v72)) {
          if (const auto ins16 = table_12.TryChangeAbsentToPresent({v71, v72}); ins16.changed) {
            if (ins16.added_row) {
              idx_216.Add({v72}, ins16.id);
            }
            return true;
          }
        } else {
  ...
  switch (__9.State({v81})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v81})) {
        if (find_260(v81)) {
          if (const auto ins17 = __9.TryChangeAbsentToPresent({v81}); ins17.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (pos_neg_50.State({v162})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (pos_neg_50.TryChangeUnknownToAbsent({v162})) {
        if (find_232(v162)) {
          if (const auto ins18 = pos_neg_50.TryChangeAbsentToPresent({v162}); ins18.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (both_pos_53.State({v164})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (both_pos_53.TryChangeUnknownToAbsent({v164})) {
        if (find_205(v164)) {
          if (const auto ins19 = both_pos_53.TryChangeAbsentToPresent({v164}); ins19.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (mixed_30.State({v166})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (mixed_30.TryChangeUnknownToAbsent({v166})) {
        if (find_167(v166)) {
          if (const auto ins20 = mixed_30.TryChangeAbsentToPresent({v166}); ins20.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_33.State({v172})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_33.TryChangeUnknownToAbsent({v172})) {
        if (find_205(v172)) {
          if (const auto ins21 = table_33.TryChangeAbsentToPresent({v172}); ins21.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_36.State({v175})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_36.TryChangeUnknownToAbsent({v175})) {
        if (find_177(v175)) {
          if (const auto ins22 = table_36.TryChangeAbsentToPresent({v175}); ins22.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_16.TryChangeUnknownToAbsent({v193, v194})) {
        if (find_196(v193, v194)) {
          if (const auto ins23 = table_16.TryChangeAbsentToPresent({v193, v194}); ins23.changed) {
            if (ins23.added_row) {
              idx_188.Add({v194}, ins23.id);
            }
            return true;
          }
        } else {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_26.TryChangeUnknownToAbsent({v244, v245})) {
        if (find_247(v244, v245)) {
          if (const auto ins24 = table_26.TryChangeAbsentToPresent({v244, v245}); ins24.changed) {
            if (ins24.added_row) {
              idx_239.Add({v245}, ins24.id);
            }
            return true;
          }
        } else {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_42.TryChangeUnknownToAbsent({v271, v272})) {
        if (find_297(v271, v272)) {
          if (const auto ins25 = table_42.TryChangeAbsentToPresent({v271, v272}); ins25.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_46.TryChangeUnknownToAbsent({v278, v279})) {
        if (find_281(v278, v279)) {
          if (const auto ins26 = table_46.TryChangeAbsentToPresent({v278, v279}); ins26.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_23.State({v287})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_23.TryChangeUnknownToAbsent({v287})) {
        if (find_289(v287)) {
          if (const auto ins27 = table_23.TryChangeAbsentToPresent({v287}); ins27.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_20.State({v303})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_20.TryChangeUnknownToAbsent({v303})) {
        if (find_289(v303)) {
          if (const auto ins28 = table_20.TryChangeAbsentToPresent({v303}); ins28.changed) {
            return true;
          }
        } else {
          return false;
      ...
      for (uint32_t j124_1 = idx_88.First({v125}); j124_1 != ::hyde::rt::kNoRow; j124_1 = idx_88.Next(j124_1)) {
        ...
        if (v125 == v126 && v125 == v127) {
          switch (__9.State({v126})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins29 = table_12.TryChangeAbsentOrUnknownToPresent({v126, v128}); ins29.changed) {
                if (ins29.added_row) {
                  idx_216.Add({v128}, ins29.id);
                }
                if (!find_80(true)) {
                  if (const auto ins30 = table_26.TryChangeAbsentOrUnknownToPresent({true, v128}); ins30.changed) {
                    if (ins30.added_row) {
                      idx_239.Add({v128}, ins30.id);
                    }
                    pos_neg_50.TryChangeAbsentOrUnknownToPresent({v128});
                  }
                }
                if (const auto ins31 = table_33.TryChangeAbsentOrUnknownToPresent({v128}); ins31.changed) {
                  mixed_30.TryChangeAbsentOrUnknownToPresent({v128});
                }
                both_pos_53.TryChangeAbsentOrUnknownToPresent({v128});
              }
              break;
            }
            default: break;
