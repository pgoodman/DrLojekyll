...
bool Database::proc_54(::hyde::rt::Vec<Tup_i32> vec56) {
  ...
  for (auto [v58] : vec56) {
    if (const auto ins0 = table_42.TryChangeAbsentToPresent({v58, true}); ins0.changed) {
      if (ins0.added_row) {
        idx_67.Add({true}, ins0.id);
      }
      vec63.Add({true});
    }
    if (const auto ins1 = table_38.TryChangeAbsentToPresent({v58, true}); ins1.changed) {
      if (ins1.added_row) {
        idx_73.Add({true}, ins1.id);
      }
      vec59.Add({true});
    }
    if (const auto ins2 = table_50.TryChangeAbsentToPresent({v58, true}); ins2.changed) {
      if (!find_60(true)) {
        if (const auto ins3 = table_5.TryChangeAbsentOrUnknownToPresent({true, v58}); ins3.changed) {
          if (ins3.added_row) {
            idx_111.Add({v58}, ins3.id);
          }
          if (const auto ins4 = table_9.TryChangeAbsentOrUnknownToPresent({v58}); ins4.changed) {
            out_neg_12.TryChangeAbsentOrUnknownToPresent({v58});
          }
        }
      }
    }
    if (const auto ins5 = table_46.TryChangeAbsentToPresent({v58, true}); ins5.changed) {
      if (ins5.added_row) {
        idx_79.Add({true}, ins5.id);
      }
      vec64.Add({true});
    }
  }
  ...
  switch (out_neg_12.State({v89})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (out_neg_12.TryChangeUnknownToAbsent({v89})) {
        if (find_90(v89)) {
          if (const auto ins6 = out_neg_12.TryChangeAbsentToPresent({v89}); ins6.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_9.State({v95})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_9.TryChangeUnknownToAbsent({v95})) {
        if (find_97(v95)) {
          if (const auto ins7 = table_9.TryChangeAbsentToPresent({v95}); ins7.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v116, v117})) {
        if (find_119(v116, v117)) {
          if (const auto ins8 = table_5.TryChangeAbsentToPresent({v116, v117}); ins8.changed) {
            if (ins8.added_row) {
              idx_111.Add({v117}, ins8.id);
            }
            return true;
          }
        } else {
  ...
  for (auto [v66] : vec63) {
    if (const uint32_t j65_0 = __15.Find({v66}); j65_0 != ::hyde::rt::kNoRow) {
      ...
      for (uint32_t j65_1 = idx_67.First({v66}); j65_1 != ::hyde::rt::kNoRow; j65_1 = idx_67.Next(j65_1)) {
        ...
        if (v66 == v68 && v66 == v69) {
          if (const auto ins9 = table_25.TryChangeAbsentToPresent({true, v70}); ins9.changed) {
            if (const auto ins10 = __22.TryChangeAbsentToPresent({true}); ins10.changed) {
              vec64.Add({true});
            }
          }
        }
  ...
  for (auto [v72] : vec59) {
    if (const uint32_t j71_0 = __15.Find({v72}); j71_0 != ::hyde::rt::kNoRow) {
      ...
      for (uint32_t j71_1 = idx_73.First({v72}); j71_1 != ::hyde::rt::kNoRow; j71_1 = idx_73.Next(j71_1)) {
        ...
        if (v72 == v74 && v72 == v75) {
          out_pos_29.TryChangeAbsentToPresent({v76});
        }
      }
    }
  }
  ...
  for (auto [v78] : vec64) {
    if (const uint32_t j77_0 = __22.Find({v78}); j77_0 != ::hyde::rt::kNoRow) {
      ...
      for (uint32_t j77_1 = idx_79.First({v78}); j77_1 != ::hyde::rt::kNoRow; j77_1 = idx_79.Next(j77_1)) {
        ...
        if (v78 == v80 && v78 == v81) {
          out_chain_32.TryChangeAbsentToPresent({v82});
        }
      }
    }
  }
