...
bool Database::proc_67(::hyde::rt::Vec<Tup_i32> vec69, ::hyde::rt::Vec<Tup_i32> vec70, ::hyde::rt::Vec<Tup_i32> vec91, ::hyde::rt::Vec<Tup_i32> vec92, ::hyde::rt::Vec<Tup_i32> vec116, ::hyde::rt::Vec<Tup_i32> vec119) {
            ...
            if (find_75(v74)) {
              if (table_23.TryChangePresentToUnknown({true, v74})) {
                if (table_47.TryChangePresentToUnknown({v74})) {
                  if (mixed_41.TryChangePresentToUnknown({v74})) {
                  }
                }
              }
            }
              ...
              if (!find_84(true)) {
                if (const auto ins3 = table_23.TryChangeAbsentOrUnknownToPresent({true, v82}); ins3.changed) {
                  ...
                  if (const auto ins4 = table_47.TryChangeAbsentOrUnknownToPresent({v82}); ins4.changed) {
                    if (const auto ins5 = mixed_41.TryChangeAbsentOrUnknownToPresent({v82}); ins5.changed) {
                    }
                  }
                }
              }
  ...
  for (auto [v94] : vec91) {
    if (const auto ins6 = table_30.TryChangeAbsentToPresent({v94}); ins6.changed) {
      if (const auto ins7 = table_57.TryChangeAbsentOrUnknownToPresent({true, v94}); ins7.changed) {
        if (const auto ins8 = __9.TryChangeAbsentOrUnknownToPresent({true}); ins8.changed) {
          for (uint32_t s95 = 0; s95 < table_19.NumRows(); ++s95) {
            ...
            if (find_98(v96, v97)) {
              if (table_33.TryChangePresentToUnknown({true, v97})) {
                if (pos_neg_61.TryChangePresentToUnknown({v97})) {
                }
              }
            }
          }
        ...
        if (__9.TryChangePresentToUnknown({true})) {
          for (uint32_t s105 = 0; s105 < table_19.NumRows(); ++s105) {
            ...
            if (find_98(v106, v107)) {
              if (!find_109(true)) {
                if (const auto ins9 = table_33.TryChangeAbsentOrUnknownToPresent({true, v107}); ins9.changed) {
                  if (ins9.added_row) {
                    idx_310.Add({v107}, ins9.id);
                  }
                  if (const auto ins10 = pos_neg_61.TryChangeAbsentOrUnknownToPresent({v107}); ins10.changed) {
                  }
                }
              }
            }
          ...
          for (uint32_t s113 = idx_112.First({true}); s113 != ::hyde::rt::kNoRow; s113 = idx_112.Next(s113)) {
            ...
            if (true == v115) {
              if (table_37.TryChangePresentToUnknown({true, v114})) {
                if (both_pos_64.TryChangePresentToUnknown({v114})) {
                }
              }
            }
          }
  ...
  for (auto [v118] : vec116) {
    if (const auto ins11 = table_12.TryChangeAbsentToPresent({v118, true}); ins11.changed) {
      if (ins11.added_row) {
        idx_87.Add({true}, ins11.id);
      }
      vec78.Add({true});
    }
  }
  for (auto [v121] : vec119) {
    if (const auto ins12 = table_50.TryChangeAbsentToPresent({v121}); ins12.changed) {
      if (!find_84(true)) {
        if (const auto ins13 = table_23.TryChangeAbsentOrUnknownToPresent({true, v121}); ins13.changed) {
          if (ins13.added_row) {
            idx_192.Add({v121}, ins13.id);
          }
          if (const auto ins14 = table_47.TryChangeAbsentOrUnknownToPresent({v121}); ins14.changed) {
            if (const auto ins15 = mixed_41.TryChangeAbsentOrUnknownToPresent({v121}); ins15.changed) {
            }
          }
        }
      }
  ...
  switch (__16.State({v85})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__16.TryChangeUnknownToAbsent({v85})) {
        if (find_382(v85)) {
          if (const auto ins16 = __16.TryChangeAbsentToPresent({v85}); ins16.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_19.TryChangeUnknownToAbsent({v99, v100})) {
        if (find_336(v99, v100)) {
          if (const auto ins17 = table_19.TryChangeAbsentToPresent({v99, v100}); ins17.changed) {
            if (ins17.added_row) {
              idx_220.Add({v100}, ins17.id);
            }
            return true;
          }
        } else {
  ...
  switch (__9.State({v110})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v110})) {
        if (find_331(v110)) {
          if (const auto ins18 = __9.TryChangeAbsentToPresent({v110}); ins18.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (pos_neg_61.State({v166})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (pos_neg_61.TryChangeUnknownToAbsent({v166})) {
        if (find_303(v166)) {
          if (const auto ins19 = pos_neg_61.TryChangeAbsentToPresent({v166}); ins19.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (both_pos_64.State({v168})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (both_pos_64.TryChangeUnknownToAbsent({v168})) {
        if (find_225(v168)) {
          if (const auto ins20 = both_pos_64.TryChangeAbsentToPresent({v168}); ins20.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (mixed_41.State({v170})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (mixed_41.TryChangeUnknownToAbsent({v170})) {
        if (find_171(v170)) {
          if (const auto ins21 = mixed_41.TryChangeAbsentToPresent({v170}); ins21.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_44.State({v176})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_44.TryChangeUnknownToAbsent({v176})) {
        if (find_209(v176)) {
          if (const auto ins22 = table_44.TryChangeAbsentToPresent({v176}); ins22.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_47.State({v179})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_47.TryChangeUnknownToAbsent({v179})) {
        if (find_181(v179)) {
          if (const auto ins23 = table_47.TryChangeAbsentToPresent({v179}); ins23.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_184(int32_t v185) {
  switch (table_47.State({v185})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_47.TryChangeUnknownToAbsent({v185})) {
        if (find_181(v185)) {
          if (const auto ins24 = table_47.TryChangeAbsentToPresent({v185}); ins24.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_23.TryChangeUnknownToAbsent({v197, v198})) {
        if (find_200(v197, v198)) {
          if (const auto ins25 = table_23.TryChangeAbsentToPresent({v197, v198}); ins25.changed) {
            if (ins25.added_row) {
              idx_192.Add({v198}, ins25.id);
            }
            return true;
          }
        } else {
...
bool Database::find_212(int32_t v213) {
  switch (table_44.State({v213})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_44.TryChangeUnknownToAbsent({v213})) {
        if (find_209(v213)) {
          if (const auto ins26 = table_44.TryChangeAbsentToPresent({v213}); ins26.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_37.TryChangeUnknownToAbsent({v237, v238})) {
        if (find_240(v237, v238)) {
          if (const auto ins27 = table_37.TryChangeAbsentToPresent({v237, v238}); ins27.changed) {
            if (ins27.added_row) {
              idx_232.Add({v238}, ins27.id);
            }
            return true;
          }
        } else {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v246, v247})) {
        if (find_286(v246, v247)) {
          if (const auto ins28 = table_5.TryChangeAbsentToPresent({v246, v247}); ins28.changed) {
            if (ins28.added_row) {
              idx_112.Add({v247}, ins28.id);
            }
            return true;
          }
        } else {
...
bool Database::find_249(bool v250) {
  switch (__9.State({v250})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v250})) {
        if (find_252(v250)) {
          if (const auto ins29 = __9.TryChangeAbsentToPresent({v250}); ins29.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_255(bool v256) {
  switch (__9.State({v256})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v256})) {
        if (find_252(v256)) {
          if (const auto ins30 = __9.TryChangeAbsentToPresent({v256}); ins30.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_57.TryChangeUnknownToAbsent({v267, v268})) {
        if (find_270(v267, v268)) {
          if (const auto ins31 = table_57.TryChangeAbsentToPresent({v267, v268}); ins31.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_30.State({v276})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_30.TryChangeUnknownToAbsent({v276})) {
        if (find_278(v276)) {
          if (const auto ins32 = table_30.TryChangeAbsentToPresent({v276}); ins32.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_281(int32_t v282) {
  switch (table_30.State({v282})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_30.TryChangeUnknownToAbsent({v282})) {
        if (find_278(v282)) {
          if (const auto ins33 = table_30.TryChangeAbsentToPresent({v282}); ins33.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_290(int32_t v291, bool v292) {
  switch (table_5.State({v291, v292})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v291, v292})) {
        if (find_286(v291, v292)) {
          if (const auto ins34 = table_5.TryChangeAbsentToPresent({v291, v292}); ins34.changed) {
            if (ins34.added_row) {
              idx_112.Add({v292}, ins34.id);
            }
            return true;
          }
        } else {
...
bool Database::find_296(int32_t v297) {
  for (uint32_t s299 = idx_220.First({v297}); s299 != ::hyde::rt::kNoRow; s299 = idx_220.Next(s299)) {
    const auto r299 = table_19.RowAt(s299);
    const auto v300 = r299.c0;
    const auto v301 = r299.x;
    if (v297 == v301) {
      if (find_98(v300, v301)) {
        return true;
      }
    }
  }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_33.TryChangeUnknownToAbsent({v315, v316})) {
        if (find_318(v315, v316)) {
          if (const auto ins35 = table_33.TryChangeAbsentToPresent({v315, v316}); ins35.changed) {
            if (ins35.added_row) {
              idx_310.Add({v316}, ins35.id);
            }
            return true;
          }
        } else {
...
bool Database::find_323(int32_t v324) {
  for (uint32_t s327 = idx_220.First({v324}); s327 != ::hyde::rt::kNoRow; s327 = idx_220.Next(s327)) {
    const auto r327 = table_19.RowAt(s327);
    const auto v328 = r327.c0;
    const auto v329 = r327.x;
    if (v324 == v329) {
      if (find_98(v328, v329)) {
        return true;
      }
    }
  }
...
bool Database::find_331(bool v332) {
  if (find_260(v332)) {
    return true;
  } else {
    return false;
...
bool Database::find_345(bool v346) {
  switch (__16.State({v346})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__16.TryChangeUnknownToAbsent({v346})) {
        if (find_348(v346)) {
          if (const auto ins36 = __16.TryChangeAbsentToPresent({v346}); ins36.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_351(bool v352) {
  switch (__16.State({v352})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__16.TryChangeUnknownToAbsent({v352})) {
        if (find_348(v352)) {
          if (const auto ins37 = __16.TryChangeAbsentToPresent({v352}); ins37.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_53.TryChangeUnknownToAbsent({v363, v364})) {
        if (find_366(v363, v364)) {
          if (const auto ins38 = table_53.TryChangeAbsentToPresent({v363, v364}); ins38.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_27.State({v372})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_27.TryChangeUnknownToAbsent({v372})) {
        if (find_374(v372)) {
          if (const auto ins39 = table_27.TryChangeAbsentToPresent({v372}); ins39.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_374(int32_t v375) {
  return false;
}

bool Database::find_377(int32_t v378) {
  switch (table_27.State({v378})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_27.TryChangeUnknownToAbsent({v378})) {
        if (find_374(v378)) {
          if (const auto ins40 = table_27.TryChangeAbsentToPresent({v378}); ins40.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_382(bool v383) {
  if (find_356(v383)) {
    return true;
  } else {
    return false;
      ...
      for (uint32_t j123_1 = idx_87.First({v124}); j123_1 != ::hyde::rt::kNoRow; j123_1 = idx_87.Next(j123_1)) {
        ...
        if (v124 == v125 && v124 == v126) {
          switch (__16.State({v125})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins41 = table_19.TryChangeAbsentOrUnknownToPresent({v125, v127}); ins41.changed) {
                if (ins41.added_row) {
                  idx_220.Add({v127}, ins41.id);
                }
                if (!find_109(true)) {
                  if (const auto ins42 = table_33.TryChangeAbsentOrUnknownToPresent({true, v127}); ins42.changed) {
                    if (ins42.added_row) {
                      idx_310.Add({v127}, ins42.id);
                    }
                    if (const auto ins43 = pos_neg_61.TryChangeAbsentOrUnknownToPresent({v127}); ins43.changed) {
                    }
                  }
                }
                if (const auto ins44 = table_5.TryChangeAbsentOrUnknownToPresent({v127, true}); ins44.changed) {
                  if (ins44.added_row) {
                    idx_112.Add({true}, ins44.id);
                  }
                  vec102.Add({true});
                }
                if (const auto ins45 = table_44.TryChangeAbsentOrUnknownToPresent({v127}); ins45.changed) {
                  if (const auto ins46 = mixed_41.TryChangeAbsentOrUnknownToPresent({v127}); ins46.changed) {
                  }
                }
              }
              break;
          ...
          switch (table_5.State({v133, v131})) {
            case ::hyde::rt::TupleState::kPresent: {
              switch (__9.State({v131})) {
                case ::hyde::rt::TupleState::kPresent: {
                  if (const auto ins47 = table_37.TryChangeAbsentOrUnknownToPresent({v131, v133}); ins47.changed) {
                    if (ins47.added_row) {
                      idx_232.Add({v133}, ins47.id);
                    }
                    if (const auto ins48 = both_pos_64.TryChangeAbsentOrUnknownToPresent({v133}); ins48.changed) {
                    }
                  }
                  break;
                }
