...
bool Database::proc_106(::hyde::rt::Vec<Tup_i32> vec108, ::hyde::rt::Vec<Tup_i32> vec109, ::hyde::rt::Vec<Tup_i32> vec144, ::hyde::rt::Vec<Tup_i32> vec145, ::hyde::rt::Vec<Tup_i32> vec170, ::hyde::rt::Vec<Tup_i32> vec173) {
                ...
                if (find_116(v114, v115)) {
                  if (table_65.TryChangePresentToUnknown({v115, v114})) {
                    if (table_78.TryChangePresentToUnknown({v114})) {
                      if (mixed_95.TryChangePresentToUnknown({v114})) {
                      }
                    }
                  }
                }
                  ...
                  if (!find_129(v127)) {
                    if (const auto ins4 = table_65.TryChangeAbsentOrUnknownToPresent({v127, v126}); ins4.changed) {
                      ...
                      if (const auto ins5 = table_78.TryChangeAbsentOrUnknownToPresent({v126}); ins5.changed) {
                        if (const auto ins6 = mixed_95.TryChangeAbsentOrUnknownToPresent({v126}); ins6.changed) {
                        }
                      }
                    }
                  }
                    ...
                    if (table_98.TryChangePresentToUnknown({v134, true})) {
                      if (table_46.TryChangePresentToUnknown({true, v134})) {
                        if (table_69.TryChangePresentToUnknown({v134})) {
                          if (pos_neg_89.TryChangePresentToUnknown({v134})) {
                          }
                        }
                      }
                    }
                    ...
                    if (table_16.TryChangePresentToUnknown({v138, true})) {
                      if (table_57.TryChangePresentToUnknown({true, v138})) {
                        if (table_72.TryChangePresentToUnknown({v138})) {
                          if (both_pos_92.TryChangePresentToUnknown({v138})) {
                          }
                        }
                      }
                    }
              ...
              if (true == v143) {
                if (table_61.TryChangePresentToUnknown({true, v142})) {
                  if (table_75.TryChangePresentToUnknown({v142})) {
                    if (mixed_95.TryChangePresentToUnknown({v142})) {
                    }
                  }
                }
              }
  ...
  for (auto [v147] : vec144) {
    if (const auto ins7 = table_30.TryChangeAbsentToPresent({v147}); ins7.changed) {
      if (const auto ins8 = table_36.TryChangeAbsentOrUnknownToPresent({v147}); ins8.changed) {
        if (const auto ins9 = table_85.TryChangeAbsentOrUnknownToPresent({true, v147}); ins9.changed) {
          if (const auto ins10 = __20.TryChangeAbsentOrUnknownToPresent({true}); ins10.changed) {
                ...
                if (find_152(v150, v151)) {
                  if (table_46.TryChangePresentToUnknown({v151, v150})) {
                    if (table_69.TryChangePresentToUnknown({v150})) {
                      if (pos_neg_89.TryChangePresentToUnknown({v150})) {
                      }
                    }
                  }
                }
            ...
            for (uint32_t s159 = idx_148.First({true}); s159 != ::hyde::rt::kNoRow; s159 = idx_148.Next(s159)) {
              ...
              if (true == v161) {
                if (find_152(v160, v161)) {
                  if (!find_163(v161)) {
                    if (const auto ins11 = table_46.TryChangeAbsentOrUnknownToPresent({v161, v160}); ins11.changed) {
                      if (ins11.added_row) {
                        idx_542.Add({v160}, ins11.id);
                      }
                      if (const auto ins12 = table_69.TryChangeAbsentOrUnknownToPresent({v160}); ins12.changed) {
                        if (const auto ins13 = pos_neg_89.TryChangeAbsentOrUnknownToPresent({v160}); ins13.changed) {
                        }
                      }
                    }
                  }
              ...
              if (true == v169) {
                if (table_57.TryChangePresentToUnknown({true, v168})) {
                  if (table_72.TryChangePresentToUnknown({v168})) {
                    if (both_pos_92.TryChangePresentToUnknown({v168})) {
                    }
                  }
                }
              }
  ...
  for (auto [v172] : vec170) {
    if (const auto ins14 = table_5.TryChangeAbsentToPresent({v172, true}); ins14.changed) {
      if (ins14.added_row) {
        idx_132.Add({true}, ins14.id);
      }
      vec120.Add({true});
    }
    if (const auto ins15 = table_12.TryChangeAbsentToPresent({v172, true}); ins15.changed) {
      if (ins15.added_row) {
        idx_136.Add({true}, ins15.id);
      }
      vec121.Add({true});
    }
    if (const auto ins16 = table_23.TryChangeAbsentToPresent({v172, true}); ins16.changed) {
      if (ins16.added_row) {
        idx_140.Add({true}, ins16.id);
      }
      vec122.Add({true});
    }
  }
  for (auto [v175] : vec173) {
    if (const auto ins17 = table_102.TryChangeAbsentToPresent({v175, true}); ins17.changed) {
      if (ins17.added_row) {
        idx_112.Add({true}, ins17.id);
      }
      if (!find_129(true)) {
        if (const auto ins18 = table_65.TryChangeAbsentOrUnknownToPresent({true, v175}); ins18.changed) {
          if (ins18.added_row) {
            idx_259.Add({v175}, ins18.id);
          }
          if (const auto ins19 = table_78.TryChangeAbsentOrUnknownToPresent({v175}); ins19.changed) {
            if (const auto ins20 = mixed_95.TryChangeAbsentOrUnknownToPresent({v175}); ins20.changed) {
            }
          }
        }
      }
  ...
  switch (__9.State({v130})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v130})) {
        if (find_615(v130)) {
          if (const auto ins21 = __9.TryChangeAbsentToPresent({v130}); ins21.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_98.TryChangeUnknownToAbsent({v153, v154})) {
        if (find_560(v153, v154)) {
          if (const auto ins22 = table_98.TryChangeAbsentToPresent({v153, v154}); ins22.changed) {
            if (ins22.added_row) {
              idx_148.Add({v154}, ins22.id);
            }
            return true;
          }
        } else {
  ...
  switch (__20.State({v164})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__20.TryChangeUnknownToAbsent({v164})) {
        if (find_608(v164)) {
          if (const auto ins23 = __20.TryChangeAbsentToPresent({v164}); ins23.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (pos_neg_89.State({v230})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (pos_neg_89.TryChangeUnknownToAbsent({v230})) {
        if (find_521(v230)) {
          if (const auto ins24 = pos_neg_89.TryChangeAbsentToPresent({v230}); ins24.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (both_pos_92.State({v232})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (both_pos_92.TryChangeUnknownToAbsent({v232})) {
        if (find_369(v232)) {
          if (const auto ins25 = both_pos_92.TryChangeAbsentToPresent({v232}); ins25.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (mixed_95.State({v234})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (mixed_95.TryChangeUnknownToAbsent({v234})) {
        if (find_235(v234)) {
          if (const auto ins26 = mixed_95.TryChangeAbsentToPresent({v234}); ins26.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_75.State({v240})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_75.TryChangeUnknownToAbsent({v240})) {
        if (find_277(v240)) {
          if (const auto ins27 = table_75.TryChangeAbsentToPresent({v240}); ins27.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_78.State({v243})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_78.TryChangeUnknownToAbsent({v243})) {
        if (find_245(v243)) {
          if (const auto ins28 = table_78.TryChangeAbsentToPresent({v243}); ins28.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_248(int32_t v249) {
  switch (table_78.State({v249})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_78.TryChangeUnknownToAbsent({v249})) {
        if (find_245(v249)) {
          if (const auto ins29 = table_78.TryChangeAbsentToPresent({v249}); ins29.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_65.TryChangeUnknownToAbsent({v264, v265})) {
        if (find_267(v264, v265)) {
          if (const auto ins30 = table_65.TryChangeAbsentToPresent({v264, v265}); ins30.changed) {
            if (ins30.added_row) {
              idx_259.Add({v265}, ins30.id);
            }
            return true;
          }
        } else {
...
bool Database::find_272(int32_t v273, bool v274) {
  switch (table_102.State({v273, v274})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
...
bool Database::find_280(int32_t v281) {
  switch (table_75.State({v281})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_75.TryChangeUnknownToAbsent({v281})) {
        if (find_277(v281)) {
          if (const auto ins31 = table_75.TryChangeAbsentToPresent({v281}); ins31.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_61.TryChangeUnknownToAbsent({v296, v297})) {
        if (find_299(v296, v297)) {
          if (const auto ins32 = table_61.TryChangeAbsentToPresent({v296, v297}); ins32.changed) {
            if (ins32.added_row) {
              idx_291.Add({v297}, ins32.id);
            }
            return true;
          }
        } else {
...
bool Database::find_308(bool v309) {
  switch (__9.State({v309})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v309})) {
        if (find_311(v309)) {
          if (const auto ins33 = __9.TryChangeAbsentToPresent({v309}); ins33.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_314(bool v315) {
  switch (__9.State({v315})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v315})) {
        if (find_311(v315)) {
          if (const auto ins34 = __9.TryChangeAbsentToPresent({v315}); ins34.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_81.TryChangeUnknownToAbsent({v326, v327})) {
        if (find_329(v326, v327)) {
          if (const auto ins35 = table_81.TryChangeAbsentToPresent({v326, v327}); ins35.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_33.State({v339})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_33.TryChangeUnknownToAbsent({v339})) {
        if (find_341(v339)) {
          if (const auto ins36 = table_33.TryChangeAbsentToPresent({v339}); ins36.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_33.State({v345})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_33.TryChangeUnknownToAbsent({v345})) {
        if (find_347(v345)) {
          if (const auto ins37 = table_33.TryChangeAbsentToPresent({v345}); ins37.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_27.State({v352})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_27.TryChangeUnknownToAbsent({v352})) {
        if (find_354(v352)) {
          if (const auto ins38 = table_27.TryChangeAbsentToPresent({v352}); ins38.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_357(int32_t v358) {
  switch (table_27.State({v358})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_27.TryChangeUnknownToAbsent({v358})) {
        if (find_354(v358)) {
          if (const auto ins39 = table_27.TryChangeAbsentToPresent({v358}); ins39.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_72.State({v374})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_72.TryChangeUnknownToAbsent({v374})) {
        if (find_376(v374)) {
          if (const auto ins40 = table_72.TryChangeAbsentToPresent({v374}); ins40.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_379(int32_t v380) {
  switch (table_72.State({v380})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_72.TryChangeUnknownToAbsent({v380})) {
        if (find_376(v380)) {
          if (const auto ins41 = table_72.TryChangeAbsentToPresent({v380}); ins41.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_57.TryChangeUnknownToAbsent({v395, v396})) {
        if (find_398(v395, v396)) {
          if (const auto ins42 = table_57.TryChangeAbsentToPresent({v395, v396}); ins42.changed) {
            if (ins42.added_row) {
              idx_390.Add({v396}, ins42.id);
            }
            return true;
          }
        } else {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_16.TryChangeUnknownToAbsent({v404, v405})) {
        if (find_468(v404, v405)) {
          if (const auto ins43 = table_16.TryChangeAbsentToPresent({v404, v405}); ins43.changed) {
            if (ins43.added_row) {
              idx_166.Add({v405}, ins43.id);
            }
            return true;
          }
        } else {
...
bool Database::find_407(bool v408) {
  switch (__20.State({v408})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__20.TryChangeUnknownToAbsent({v408})) {
        if (find_410(v408)) {
          if (const auto ins44 = __20.TryChangeAbsentToPresent({v408}); ins44.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_413(bool v414) {
  switch (__20.State({v414})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__20.TryChangeUnknownToAbsent({v414})) {
        if (find_410(v414)) {
          if (const auto ins45 = __20.TryChangeAbsentToPresent({v414}); ins45.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_85.TryChangeUnknownToAbsent({v425, v426})) {
        if (find_428(v425, v426)) {
          if (const auto ins46 = table_85.TryChangeAbsentToPresent({v425, v426}); ins46.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_36.State({v438})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_36.TryChangeUnknownToAbsent({v438})) {
        if (find_440(v438)) {
          if (const auto ins47 = table_36.TryChangeAbsentToPresent({v438}); ins47.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_36.State({v444})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_36.TryChangeUnknownToAbsent({v444})) {
        if (find_446(v444)) {
          if (const auto ins48 = table_36.TryChangeAbsentToPresent({v444}); ins48.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_30.State({v451})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_30.TryChangeUnknownToAbsent({v451})) {
        if (find_453(v451)) {
          if (const auto ins49 = table_30.TryChangeAbsentToPresent({v451}); ins49.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_453(int32_t v454) {
  if (find_461(v454)) {
    return true;
  } else {
    return false;
...
bool Database::find_456(int32_t v457) {
  switch (table_30.State({v457})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_30.TryChangeUnknownToAbsent({v457})) {
        if (find_453(v457)) {
          if (const auto ins50 = table_30.TryChangeAbsentToPresent({v457}); ins50.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_461(int32_t v462) {
  if (find_464(v462)) {
    return true;
  } else {
    return false;
...
bool Database::find_464(int32_t v465) {
  return false;
}
...
bool Database::find_472(int32_t v473, bool v474) {
  switch (table_16.State({v473, v474})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_16.TryChangeUnknownToAbsent({v473, v474})) {
        if (find_468(v473, v474)) {
          if (const auto ins51 = table_16.TryChangeAbsentToPresent({v473, v474}); ins51.changed) {
            if (ins51.added_row) {
              idx_166.Add({v474}, ins51.id);
            }
            return true;
          }
        } else {
  ...
  switch (table_54.State({v479})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_54.TryChangeUnknownToAbsent({v479})) {
        if (find_481(v479)) {
          if (const auto ins52 = table_54.TryChangeAbsentToPresent({v479}); ins52.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_484(int32_t v485) {
  switch (table_54.State({v485})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_54.TryChangeUnknownToAbsent({v485})) {
        if (find_481(v485)) {
          if (const auto ins53 = table_54.TryChangeAbsentToPresent({v485}); ins53.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_50.TryChangeUnknownToAbsent({v497, v498})) {
        if (find_500(v497, v498)) {
          if (const auto ins54 = table_50.TryChangeAbsentToPresent({v497, v498}); ins54.changed) {
            if (ins54.added_row) {
              idx_492.Add({v498}, ins54.id);
            }
            return true;
          }
        } else {
...
bool Database::find_509(bool v510) {
  switch (__9.State({v510})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v510})) {
        if (find_512(v510)) {
          if (const auto ins55 = __9.TryChangeAbsentToPresent({v510}); ins55.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_512(bool v513) {
  if (find_319(v513)) {
    return true;
  } else {
    return false;
...
bool Database::find_515(bool v516) {
  switch (__9.State({v516})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v516})) {
        if (find_512(v516)) {
          if (const auto ins56 = __9.TryChangeAbsentToPresent({v516}); ins56.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_69.State({v526})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_69.TryChangeUnknownToAbsent({v526})) {
        if (find_528(v526)) {
          if (const auto ins57 = table_69.TryChangeAbsentToPresent({v526}); ins57.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_531(int32_t v532) {
  switch (table_69.State({v532})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_69.TryChangeUnknownToAbsent({v532})) {
        if (find_528(v532)) {
          if (const auto ins58 = table_69.TryChangeAbsentToPresent({v532}); ins58.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_46.TryChangeUnknownToAbsent({v547, v548})) {
        if (find_550(v547, v548)) {
          if (const auto ins59 = table_46.TryChangeAbsentToPresent({v547, v548}); ins59.changed) {
            if (ins59.added_row) {
              idx_542.Add({v548}, ins59.id);
            }
            return true;
          }
        } else {
...
bool Database::find_555(int32_t v556, bool v557) {
  switch (table_98.State({v556, v557})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_98.TryChangeUnknownToAbsent({v556, v557})) {
        if (find_560(v556, v557)) {
          if (const auto ins60 = table_98.TryChangeAbsentToPresent({v556, v557}); ins60.changed) {
            if (ins60.added_row) {
              idx_148.Add({v557}, ins60.id);
            }
            return true;
          }
        } else {
  ...
  switch (table_43.State({v566})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_43.TryChangeUnknownToAbsent({v566})) {
        if (find_568(v566)) {
          if (const auto ins61 = table_43.TryChangeAbsentToPresent({v566}); ins61.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_571(int32_t v572) {
  switch (table_43.State({v572})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_43.TryChangeUnknownToAbsent({v572})) {
        if (find_568(v572)) {
          if (const auto ins62 = table_43.TryChangeAbsentToPresent({v572}); ins62.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_39.TryChangeUnknownToAbsent({v584, v585})) {
        if (find_587(v584, v585)) {
          if (const auto ins63 = table_39.TryChangeAbsentToPresent({v584, v585}); ins63.changed) {
            if (ins63.added_row) {
              idx_579.Add({v585}, ins63.id);
            }
            return true;
          }
        } else {
...
bool Database::find_596(bool v597) {
  switch (__9.State({v597})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v597})) {
        if (find_599(v597)) {
          if (const auto ins64 = __9.TryChangeAbsentToPresent({v597}); ins64.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_599(bool v600) {
  if (find_319(v600)) {
    return true;
  } else {
    return false;
...
bool Database::find_602(bool v603) {
  switch (__9.State({v603})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v603})) {
        if (find_599(v603)) {
          if (const auto ins65 = __9.TryChangeAbsentToPresent({v603}); ins65.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_608(bool v609) {
  if (find_418(v609)) {
    return true;
  } else {
    return false;
...
bool Database::find_615(bool v616) {
  if (find_319(v616)) {
    return true;
  } else {
    return false;
      ...
      for (uint32_t j177_1 = idx_140.First({v178}); j177_1 != ::hyde::rt::kNoRow; j177_1 = idx_140.Next(j177_1)) {
        ...
        if (v178 == v179 && v178 == v180) {
          switch (__9.State({v179})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins66 = table_61.TryChangeAbsentOrUnknownToPresent({v179, v181}); ins66.changed) {
                if (ins66.added_row) {
                  idx_291.Add({v181}, ins66.id);
                }
                if (const auto ins67 = table_75.TryChangeAbsentOrUnknownToPresent({v181}); ins67.changed) {
                  if (const auto ins68 = mixed_95.TryChangeAbsentOrUnknownToPresent({v181}); ins68.changed) {
                  }
                }
              }
              break;
      ...
      for (uint32_t j182_1 = idx_136.First({v183}); j182_1 != ::hyde::rt::kNoRow; j182_1 = idx_136.Next(j182_1)) {
        ...
        if (v183 == v184 && v183 == v185) {
          switch (__9.State({v184})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins69 = table_50.TryChangeAbsentOrUnknownToPresent({v184, v186}); ins69.changed) {
                if (ins69.added_row) {
                  idx_492.Add({v186}, ins69.id);
                }
                if (const auto ins70 = table_54.TryChangeAbsentOrUnknownToPresent({v186}); ins70.changed) {
                  if (const auto ins71 = table_16.TryChangeAbsentOrUnknownToPresent({v186, true}); ins71.changed) {
                    if (ins71.added_row) {
                      idx_166.Add({true}, ins71.id);
                    }
                    vec156.Add({true});
                  }
                }
      ...
      for (uint32_t j187_1 = idx_132.First({v188}); j187_1 != ::hyde::rt::kNoRow; j187_1 = idx_132.Next(j187_1)) {
        ...
        if (v188 == v189 && v188 == v190) {
          switch (__9.State({v189})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins72 = table_39.TryChangeAbsentOrUnknownToPresent({v189, v191}); ins72.changed) {
                if (ins72.added_row) {
                  idx_579.Add({v191}, ins72.id);
                }
                if (const auto ins73 = table_43.TryChangeAbsentOrUnknownToPresent({v191}); ins73.changed) {
                  if (const auto ins74 = table_98.TryChangeAbsentOrUnknownToPresent({v191, true}); ins74.changed) {
                    if (ins74.added_row) {
                      idx_148.Add({true}, ins74.id);
                    }
                    if (!find_163(true)) {
                      if (const auto ins75 = table_46.TryChangeAbsentOrUnknownToPresent({true, v191}); ins75.changed) {
                        if (ins75.added_row) {
                          idx_542.Add({v191}, ins75.id);
                        }
                        if (const auto ins76 = table_69.TryChangeAbsentOrUnknownToPresent({v191}); ins76.changed) {
                          if (const auto ins77 = pos_neg_89.TryChangeAbsentOrUnknownToPresent({v191}); ins77.changed) {
                          }
                        }
                      }
                    }
          ...
          switch (table_16.State({v197, v195})) {
            case ::hyde::rt::TupleState::kPresent: {
              switch (__20.State({v195})) {
                case ::hyde::rt::TupleState::kPresent: {
                  if (const auto ins78 = table_57.TryChangeAbsentOrUnknownToPresent({v195, v197}); ins78.changed) {
                    if (ins78.added_row) {
                      idx_390.Add({v197}, ins78.id);
                    }
                    if (const auto ins79 = table_72.TryChangeAbsentOrUnknownToPresent({v197}); ins79.changed) {
                      if (const auto ins80 = both_pos_92.TryChangeAbsentOrUnknownToPresent({v197}); ins80.changed) {
                      }
                    }
                  }
                  break;
