...
bool Database::proc_36(::hyde::rt::Vec<Tup_i32> vec38, ::hyde::rt::Vec<Tup_i32_i32> vec47, ::hyde::rt::Vec<Tup_i32> vec52, ::hyde::rt::Vec<Tup_i32_i32> vec56) {
  ...
  vec52.Clear();
  vec56.Clear();
  flow_141(std::move(vec42), std::move(vec44), std::move(vec55), std::move(vec60));
  return false;
}
...
bool Database::flow_141(::hyde::rt::Vec<Tup_i32> vec42, ::hyde::rt::Vec<Tup_i32> vec44, ::hyde::rt::Vec<Tup_i32> vec55, ::hyde::rt::Vec<Tup_i32> vec60) {
  ...
  for (bool reenter41 = true; reenter41; ) {
    for (bool changed41 = true; changed41; changed41 = !(true && vec42.Empty() && vec44.Empty() && vec60.Empty() && vec62.Empty() && vec64.Empty())) {
      ...
      for (auto [v95] : vec43) {
        if (const uint32_t j94_0 = table_15.Find({v95}); j94_0 != ::hyde::rt::kNoRow) {
          ...
          for (uint32_t j94_1 = idx_96.First({v95}); j94_1 != ::hyde::rt::kNoRow; j94_1 = idx_96.Next(j94_1)) {
            ...
            if (v95 == v97 && v95 == v98) {
              if (const auto ins6 = table_15.TryChangeAbsentToPresent({v99}); ins6.changed) {
      ...
      vec44.Swap(vec45);
      for (auto [v75] : vec45) {
        if (const auto ins7 = table_18.TryChangeAbsentToPresent({v75}); ins7.changed) {
          const uint64_t v83 = 0;
          (void) v83;
          vec62.Add({v75});
        }
        const uint64_t v84 = 0;
        (void) v84;
        vec42.Add({v75});
        vec85.Add({v75});
      }
        ...
        if (const uint32_t j100_0 = table_18.Find({v101}); j100_0 != ::hyde::rt::kNoRow) {
          ...
          for (uint32_t j100_1 = idx_102.First({v101}); j100_1 != ::hyde::rt::kNoRow; j100_1 = idx_102.Next(j100_1)) {
            ...
            if (v101 == v103 && v101 == v104) {
              if (const auto ins8 = table_32.TryChangeAbsentToPresent({v105, true}); ins8.changed) {
                if (ins8.added_row) {
                  idx_108.Add({true}, ins8.id);
                }
      ...
      vec62.Swap(vec63);
      for (auto [v79] : vec63) {
        out_12.TryChangeAbsentToPresent({v79});
        ...
        if (const uint32_t j106_0 = __5.Find({v107}); j106_0 != ::hyde::rt::kNoRow) {
          ...
          for (uint32_t j106_1 = idx_108.First({v107}); j106_1 != ::hyde::rt::kNoRow; j106_1 = idx_108.Next(j106_1)) {
            ...
            if (v107 == v109 && v107 == v110) {
              if (const auto ins9 = table_18.TryChangeAbsentToPresent({v111}); ins9.changed) {
      ...
      for (auto [v90] : vec85) {
        if (const uint32_t j89_0 = table_15.Find({v90}); j89_0 != ::hyde::rt::kNoRow) {
          ...
          if (const uint32_t j89_1 = table_25.Find({v90}); j89_1 != ::hyde::rt::kNoRow) {
            ...
            if (v90 == v91 && v90 == v92) {
              if (const auto ins10 = table_8.TryChangeAbsentToPresent({true, v91}); ins10.changed) {
                if (const auto ins11 = __5.TryChangeAbsentToPresent({true}); ins11.changed) {
