...
class Database {
 ...
 private:
  bool init_4();
  bool proc_20(::hyde::rt::Vec<Tup_i32> vec29, ::hyde::rt::Vec<Tup_i32> vec33);
  bool flow_62(::hyde::rt::Vec<Tup_i32> vec23, ::hyde::rt::Vec<Tup_b> vec26);
