          ...
          for (uint32_t s43 = idx_42.First({true}); s43 != ::hyde::rt::kNoRow; s43 = idx_42.Next(s43)) {
            ...
            if (true == v45) {
              if (table_18.TryChangePresentToUnknown({true, v44})) {
                gated_30.TryChangePresentToUnknown({v44});
              }
            }
          }
        }
          ...
          for (uint32_t s52 = idx_42.First({true}); s52 != ::hyde::rt::kNoRow; s52 = idx_42.Next(s52)) {
            ...
            if (true == v54) {
              if (table_18.TryChangePresentToUnknown({true, v53})) {
                gated_30.TryChangePresentToUnknown({v53});
              }
            }
          }
        }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_22.TryChangeUnknownToAbsent({v128, v129})) {
        if (find_154(v128, v129)) {
          if (const auto ins10 = table_22.TryChangeAbsentToPresent({v128, v129}); ins10.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_26.TryChangeUnknownToAbsent({v135, v136})) {
        if (find_138(v135, v136)) {
          if (const auto ins11 = table_26.TryChangeAbsentToPresent({v135, v136}); ins11.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_15.State({v144})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_15.TryChangeUnknownToAbsent({v144})) {
        if (find_146(v144)) {
          if (const auto ins12 = table_15.TryChangeAbsentToPresent({v144}); ins12.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_12.State({v160})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_12.TryChangeUnknownToAbsent({v160})) {
        if (find_146(v160)) {
          if (const auto ins13 = table_12.TryChangeAbsentToPresent({v160}); ins13.changed) {
            return true;
          }
        } else {
          return false;
      ...
      for (uint32_t j58_1 = idx_42.First({v59}); j58_1 != ::hyde::rt::kNoRow; j58_1 = idx_42.Next(j58_1)) {
        ...
        if (v59 == v60 && v59 == v61) {
          switch (__9.State({v60})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins14 = table_18.TryChangeAbsentOrUnknownToPresent({v60, v62}); ins14.changed) {
                if (ins14.added_row) {
                  idx_93.Add({v62}, ins14.id);
                }
                gated_30.TryChangeAbsentOrUnknownToPresent({v62});
              }
              break;
            }
            default: break;
