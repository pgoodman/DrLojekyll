              ...
              if (true == v54) {
                if (table_24.TryChangePresentToUnknown({true, v53})) {
                  if (table_28.TryChangePresentToUnknown({v53})) {
                    gated_39.TryChangePresentToUnknown({v53});
                  }
                }
              }
            }
              ...
              if (true == v63) {
                if (table_24.TryChangePresentToUnknown({true, v62})) {
                  if (table_28.TryChangePresentToUnknown({v62})) {
                    gated_39.TryChangePresentToUnknown({v62});
                  }
                }
              }
            }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_24.TryChangeUnknownToAbsent({v121, v122})) {
        if (find_124(v121, v122)) {
          if (const auto ins11 = table_24.TryChangeAbsentToPresent({v121, v122}); ins11.changed) {
            if (ins11.added_row) {
              idx_116.Add({v122}, ins11.id);
            }
            return true;
          }
        } else {
  ...
  switch (__9.State({v134})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v134})) {
        if (find_136(v134)) {
          if (const auto ins12 = __9.TryChangeAbsentToPresent({v134}); ins12.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_31.TryChangeUnknownToAbsent({v151, v152})) {
        if (find_201(v151, v152)) {
          if (const auto ins13 = table_31.TryChangeAbsentToPresent({v151, v152}); ins13.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_35.TryChangeUnknownToAbsent({v158, v159})) {
        if (find_161(v158, v159)) {
          if (const auto ins14 = table_35.TryChangeAbsentToPresent({v158, v159}); ins14.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_21.State({v171})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_21.TryChangeUnknownToAbsent({v171})) {
        if (find_173(v171)) {
          if (const auto ins15 = table_21.TryChangeAbsentToPresent({v171}); ins15.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_21.State({v177})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_21.TryChangeUnknownToAbsent({v177})) {
        if (find_179(v177)) {
          if (const auto ins16 = table_21.TryChangeAbsentToPresent({v177}); ins16.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_15.State({v184})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_15.TryChangeUnknownToAbsent({v184})) {
        if (find_186(v184)) {
          if (const auto ins17 = table_15.TryChangeAbsentToPresent({v184}); ins17.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_18.State({v211})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v211})) {
        if (find_213(v211)) {
          if (const auto ins18 = table_18.TryChangeAbsentToPresent({v211}); ins18.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_18.State({v217})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v217})) {
        if (find_219(v217)) {
          if (const auto ins19 = table_18.TryChangeAbsentToPresent({v217}); ins19.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_12.State({v224})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_12.TryChangeUnknownToAbsent({v224})) {
        if (find_186(v224)) {
          if (const auto ins20 = table_12.TryChangeAbsentToPresent({v224}); ins20.changed) {
            return true;
          }
        } else {
          return false;
      ...
      for (uint32_t j67_1 = idx_51.First({v68}); j67_1 != ::hyde::rt::kNoRow; j67_1 = idx_51.Next(j67_1)) {
        ...
        if (v68 == v69 && v68 == v70) {
          switch (__9.State({v69})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins21 = table_24.TryChangeAbsentOrUnknownToPresent({v69, v71}); ins21.changed) {
                if (ins21.added_row) {
                  idx_116.Add({v71}, ins21.id);
                }
                if (const auto ins22 = table_28.TryChangeAbsentOrUnknownToPresent({v71}); ins22.changed) {
                  gated_39.TryChangeAbsentOrUnknownToPresent({v71});
                }
              }
              break;
            }
