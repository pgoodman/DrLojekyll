            ...
            if (find_42(v40, v41)) {
              if (table_5.TryChangePresentToUnknown({v41, v40})) {
                if (table_9.TryChangePresentToUnknown({v40})) {
                  if (off_vals_12.TryChangePresentToUnknown({v40})) {
                  }
                }
              }
            }
      ...
      if (!find_50(true)) {
        if (const auto ins4 = table_5.TryChangeAbsentOrUnknownToPresent({true, v49}); ins4.changed) {
          ...
          if (const auto ins5 = table_9.TryChangeAbsentOrUnknownToPresent({v49}); ins5.changed) {
            if (const auto ins6 = off_vals_12.TryChangeAbsentOrUnknownToPresent({v49}); ins6.changed) {
            }
          }
        }
      }
  ...
  switch (off_vals_12.State({v71})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (off_vals_12.TryChangeUnknownToAbsent({v71})) {
        if (find_72(v71)) {
          if (const auto ins7 = off_vals_12.TryChangeAbsentToPresent({v71}); ins7.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_9.State({v77})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_9.TryChangeUnknownToAbsent({v77})) {
        if (find_79(v77)) {
          if (const auto ins8 = table_9.TryChangeAbsentToPresent({v77}); ins8.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_82(int32_t v83) {
  switch (table_9.State({v83})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_9.TryChangeUnknownToAbsent({v83})) {
        if (find_79(v83)) {
          if (const auto ins9 = table_9.TryChangeAbsentToPresent({v83}); ins9.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_5.State({v98, v99})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v98, v99})) {
        if (find_101(v98, v99)) {
          if (const auto ins10 = table_5.TryChangeAbsentToPresent({v98, v99}); ins10.changed) {
            if (ins10.added_row) {
              idx_93.Add({v99}, ins10.id);
            }
            return true;
          }
        } else {
...
bool Database::find_106(int32_t v107, bool v108) {
  switch (table_29.State({v107, v108})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
  ...
  for (auto [v54] : vec46) {
    if (const uint32_t j53_0 = __15.Find({v54}); j53_0 != ::hyde::rt::kNoRow) {
      ...
      for (uint32_t j53_1 = idx_55.First({v54}); j53_1 != ::hyde::rt::kNoRow; j53_1 = idx_55.Next(j53_1)) {
        ...
        if (v54 == v56 && v54 == v57) {
          if (const auto ins11 = on_vals_22.TryChangeAbsentToPresent({v58}); ins11.changed) {
          }
        }
      }
    }
