      ...
      if (const auto ins0 = table_43.TryChangeAbsentToPresent({v72, 7}); ins0.changed) {
        if (find_74(v72, 7)) {
          if (table_18.TryChangePresentToUnknown({v72, 7})) {
            if (out7_34.TryChangePresentToUnknown({v72})) {
            }
          }
        }
      }
      ...
      if (const auto ins1 = table_51.TryChangeAbsentToPresent({v72, v72}); ins1.changed) {
        if (find_78(v72, v72)) {
          if (table_22.TryChangePresentToUnknown({v72, v72})) {
            if (outdup_37.TryChangePresentToUnknown({v72})) {
            }
          }
        }
      }
                  ...
                  for (uint32_t s87 = idx_86.First({true}); s87 != ::hyde::rt::kNoRow; s87 = idx_86.Next(s87)) {
                    ...
                    if (true == v89) {
                      if (table_26.TryChangePresentToUnknown({true, v88})) {
                        if (outflag_40.TryChangePresentToUnknown({v88})) {
                        }
                      }
                    }
                  }
    ...
    if (const auto ins3 = table_47.TryChangeAbsentToPresent({v92, 7}); ins3.changed) {
      if (!find_93(v92, 7)) {
        if (const auto ins4 = table_18.TryChangeAbsentOrUnknownToPresent({v92, 7}); ins4.changed) {
          ...
          if (const auto ins5 = out7_34.TryChangeAbsentOrUnknownToPresent({v92}); ins5.changed) {
          }
        }
      }
    }
    if (const auto ins6 = table_55.TryChangeAbsentToPresent({v92, v92}); ins6.changed) {
      if (!find_97(v92, v92)) {
        if (const auto ins7 = table_22.TryChangeAbsentOrUnknownToPresent({v92, v92}); ins7.changed) {
          if (ins7.added_row) {
            idx_205.Add({v92}, ins7.id);
          }
          if (const auto ins8 = outdup_37.TryChangeAbsentOrUnknownToPresent({v92}); ins8.changed) {
          }
        }
      }
    }
    if (1 == v92) {
      if (const auto ins9 = table_63.TryChangeAbsentToPresent({1, 7}); ins9.changed) {
        if (!find_101(1, 7)) {
          if (const auto ins10 = table_14.TryChangeAbsentOrUnknownToPresent({1, 7}); ins10.changed) {
            if (ins10.added_row) {
              idx_180.Add({1}, ins10.id);
            }
            if (const auto ins11 = table_30.TryChangeAbsentOrUnknownToPresent({true, 1}); ins11.changed) {
  ...
  switch (out7_34.State({v122})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (out7_34.TryChangeUnknownToAbsent({v122})) {
        if (find_223(v122)) {
          if (const auto ins13 = out7_34.TryChangeAbsentToPresent({v122}); ins13.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (outdup_37.State({v124})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (outdup_37.TryChangeUnknownToAbsent({v124})) {
        if (find_198(v124)) {
          if (const auto ins14 = outdup_37.TryChangeAbsentToPresent({v124}); ins14.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (outflag_40.State({v126})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (outflag_40.TryChangeUnknownToAbsent({v126})) {
        if (find_127(v126)) {
          if (const auto ins15 = outflag_40.TryChangeAbsentToPresent({v126}); ins15.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_26.TryChangeUnknownToAbsent({v139, v140})) {
        if (find_142(v139, v140)) {
          if (const auto ins16 = table_26.TryChangeAbsentToPresent({v139, v140}); ins16.changed) {
            if (ins16.added_row) {
              idx_134.Add({v140}, ins16.id);
            }
            return true;
          }
        } else {
  ...
  switch (__11.State({v152})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__11.TryChangeUnknownToAbsent({v152})) {
        if (find_154(v152)) {
          if (const auto ins17 = __11.TryChangeAbsentToPresent({v152}); ins17.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_157(bool v158) {
  switch (__11.State({v158})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__11.TryChangeUnknownToAbsent({v158})) {
        if (find_154(v158)) {
          if (const auto ins18 = __11.TryChangeAbsentToPresent({v158}); ins18.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_30.TryChangeUnknownToAbsent({v169, v170})) {
        if (find_172(v169, v170)) {
          if (const auto ins19 = table_30.TryChangeAbsentToPresent({v169, v170}); ins19.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_14.TryChangeUnknownToAbsent({v185, v186})) {
        if (find_188(v185, v186)) {
          if (const auto ins20 = table_14.TryChangeAbsentToPresent({v185, v186}); ins20.changed) {
            if (ins20.added_row) {
              idx_180.Add({v185}, ins20.id);
            }
            return true;
          }
        } else {
...
bool Database::find_193(int32_t v194, int32_t v195) {
  switch (table_63.State({v194, v195})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_22.TryChangeUnknownToAbsent({v210, v211})) {
        if (find_213(v210, v211)) {
          if (const auto ins21 = table_22.TryChangeAbsentToPresent({v210, v211}); ins21.changed) {
            if (ins21.added_row) {
              idx_205.Add({v210}, ins21.id);
            }
            return true;
          }
        } else {
...
bool Database::find_218(int32_t v219, int32_t v220) {
  switch (table_55.State({v219, v220})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v235, v236})) {
        if (find_238(v235, v236)) {
          if (const auto ins22 = table_18.TryChangeAbsentToPresent({v235, v236}); ins22.changed) {
            if (ins22.added_row) {
              idx_230.Add({v235}, ins22.id);
            }
            return true;
          }
        } else {
...
bool Database::find_243(int32_t v244, int32_t v245) {
  switch (table_47.State({v244, v245})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
...
bool Database::flow_248(::hyde::rt::Vec<Tup_b> vec69) {
  if ((g68 += 1) == 1) {
    if (const auto ins23 = table_7.TryChangeAbsentToPresent({1, true}); ins23.changed) {
      if (ins23.added_row) {
        idx_86.Add({true}, ins23.id);
      }
      vec69.Add({true});
    }
  }
      ...
      for (uint32_t j105_1 = idx_86.First({v106}); j105_1 != ::hyde::rt::kNoRow; j105_1 = idx_86.Next(j105_1)) {
        ...
        if (v106 == v107 && v106 == v108) {
          switch (__11.State({v107})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins24 = table_26.TryChangeAbsentOrUnknownToPresent({v107, v109}); ins24.changed) {
                if (ins24.added_row) {
                  idx_134.Add({v109}, ins24.id);
                }
                if (const auto ins25 = outflag_40.TryChangeAbsentOrUnknownToPresent({v109}); ins25.changed) {
                }
              }
              break;
            }
