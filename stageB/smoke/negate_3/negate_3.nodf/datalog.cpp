        ...
        if (find_86(v84, 7)) {
          if (table_14.TryChangePresentToUnknown({v84, 7})) {
            if (table_33.TryChangePresentToUnknown({v84})) {
              out7_46.TryChangePresentToUnknown({v84});
            }
          }
        }
      }
        ...
        if (find_90(v84, v84)) {
          if (table_18.TryChangePresentToUnknown({v84, v84})) {
            if (table_36.TryChangePresentToUnknown({v84})) {
              outdup_49.TryChangePresentToUnknown({v84});
            }
          }
        }
      }
                      ...
                      if (table_26.TryChangePresentToUnknown({true, v100})) {
                        if (table_39.TryChangePresentToUnknown({v100})) {
                          if (table_30.TryChangePresentToUnknown({v100})) {
                            outflag_52.TryChangePresentToUnknown({v100});
                          }
                        }
                      }
                    }
      ...
      if (!find_105(v104, 7)) {
        if (const auto ins4 = table_14.TryChangeAbsentOrUnknownToPresent({v104, 7}); ins4.changed) {
          ...
          if (const auto ins5 = table_33.TryChangeAbsentOrUnknownToPresent({v104}); ins5.changed) {
            out7_46.TryChangeAbsentOrUnknownToPresent({v104});
          }
        }
      }
    }
    if (const auto ins6 = table_67.TryChangeAbsentToPresent({v104, v104}); ins6.changed) {
      if (!find_109(v104, v104)) {
        if (const auto ins7 = table_18.TryChangeAbsentOrUnknownToPresent({v104, v104}); ins7.changed) {
          if (ins7.added_row) {
            idx_269.Add({v104}, ins7.id);
          }
          if (const auto ins8 = table_36.TryChangeAbsentOrUnknownToPresent({v104}); ins8.changed) {
            outdup_49.TryChangeAbsentOrUnknownToPresent({v104});
          }
        }
      }
    }
    if (1 == v104) {
      if (const auto ins9 = table_75.TryChangeAbsentToPresent({1, 7}); ins9.changed) {
        if (!find_113(1, 7)) {
          if (const auto ins10 = table_22.TryChangeAbsentOrUnknownToPresent({1, 7}); ins10.changed) {
            if (ins10.added_row) {
              idx_223.Add({1}, ins10.id);
            }
            if (const auto ins11 = table_42.TryChangeAbsentOrUnknownToPresent({true, 1}); ins11.changed) {
              if (const auto ins12 = __11.TryChangeAbsentOrUnknownToPresent({true}); ins12.changed) {
                vec81.Add({true});
              }
            }
          }
  ...
  switch (out7_46.State({v134})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (out7_46.TryChangeUnknownToAbsent({v134})) {
        if (find_287(v134)) {
          if (const auto ins13 = out7_46.TryChangeAbsentToPresent({v134}); ins13.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (outdup_49.State({v136})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (outdup_49.TryChangeUnknownToAbsent({v136})) {
        if (find_248(v136)) {
          if (const auto ins14 = outdup_49.TryChangeAbsentToPresent({v136}); ins14.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (outflag_52.State({v138})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (outflag_52.TryChangeUnknownToAbsent({v138})) {
        if (find_139(v138)) {
          if (const auto ins15 = outflag_52.TryChangeAbsentToPresent({v138}); ins15.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_30.State({v144})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_30.TryChangeUnknownToAbsent({v144})) {
        if (find_146(v144)) {
          if (const auto ins16 = table_30.TryChangeAbsentToPresent({v144}); ins16.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_30.State({v150})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_30.TryChangeUnknownToAbsent({v150})) {
        if (find_152(v150)) {
          if (const auto ins17 = table_30.TryChangeAbsentToPresent({v150}); ins17.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_39.State({v157})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_39.TryChangeUnknownToAbsent({v157})) {
        if (find_159(v157)) {
          if (const auto ins18 = table_39.TryChangeAbsentToPresent({v157}); ins18.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_26.TryChangeUnknownToAbsent({v178, v179})) {
        if (find_181(v178, v179)) {
          if (const auto ins19 = table_26.TryChangeAbsentToPresent({v178, v179}); ins19.changed) {
            if (ins19.added_row) {
              idx_173.Add({v179}, ins19.id);
            }
            return true;
          }
        } else {
  ...
  switch (__11.State({v191})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__11.TryChangeUnknownToAbsent({v191})) {
        if (find_193(v191)) {
          if (const auto ins20 = __11.TryChangeAbsentToPresent({v191}); ins20.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_42.TryChangeUnknownToAbsent({v208, v209})) {
        if (find_211(v208, v209)) {
          if (const auto ins21 = table_42.TryChangeAbsentToPresent({v208, v209}); ins21.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_22.TryChangeUnknownToAbsent({v228, v229})) {
        if (find_231(v228, v229)) {
          if (const auto ins22 = table_22.TryChangeAbsentToPresent({v228, v229}); ins22.changed) {
            if (ins22.added_row) {
              idx_223.Add({v228}, ins22.id);
            }
            return true;
          }
        } else {
  ...
  switch (table_36.State({v253})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_36.TryChangeUnknownToAbsent({v253})) {
        if (find_255(v253)) {
          if (const auto ins23 = table_36.TryChangeAbsentToPresent({v253}); ins23.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v274, v275})) {
        if (find_277(v274, v275)) {
          if (const auto ins24 = table_18.TryChangeAbsentToPresent({v274, v275}); ins24.changed) {
            if (ins24.added_row) {
              idx_269.Add({v274}, ins24.id);
            }
            return true;
          }
        } else {
  ...
  switch (table_33.State({v292})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_33.TryChangeUnknownToAbsent({v292})) {
        if (find_294(v292)) {
          if (const auto ins25 = table_33.TryChangeAbsentToPresent({v292}); ins25.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_14.TryChangeUnknownToAbsent({v313, v314})) {
        if (find_316(v313, v314)) {
          if (const auto ins26 = table_14.TryChangeAbsentToPresent({v313, v314}); ins26.changed) {
            if (ins26.added_row) {
              idx_308.Add({v313}, ins26.id);
            }
            return true;
          }
        } else {
...
bool Database::flow_326(::hyde::rt::Vec<Tup_b> vec81) {
  if ((g80 += 1) == 1) {
    if (const auto ins27 = table_7.TryChangeAbsentToPresent({1, true}); ins27.changed) {
      if (ins27.added_row) {
        idx_98.Add({true}, ins27.id);
      }
      vec81.Add({true});
    }
  }
      ...
      for (uint32_t j117_1 = idx_98.First({v118}); j117_1 != ::hyde::rt::kNoRow; j117_1 = idx_98.Next(j117_1)) {
        ...
        if (v118 == v119 && v118 == v120) {
          switch (__11.State({v119})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins28 = table_26.TryChangeAbsentOrUnknownToPresent({v119, v121}); ins28.changed) {
                if (ins28.added_row) {
                  idx_173.Add({v121}, ins28.id);
                }
                if (const auto ins29 = table_39.TryChangeAbsentOrUnknownToPresent({v121}); ins29.changed) {
                  if (const auto ins30 = table_30.TryChangeAbsentOrUnknownToPresent({v121}); ins30.changed) {
                    outflag_52.TryChangeAbsentOrUnknownToPresent({v121});
                  }
                }
              }
              break;
