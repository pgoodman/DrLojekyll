            ...
            for (uint32_t s46 = idx_45.First({true}); s46 != ::hyde::rt::kNoRow; s46 = idx_45.Next(s46)) {
              ...
              if (true == v48) {
                if (table_21.TryChangePresentToUnknown({true, v47})) {
                  if (user_is_logged_in_29.TryChangePresentToUnknown({v47})) {
                  }
                }
              }
            }
...
bool Database::find_102(bool v103) {
  switch (__15.State({v103})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__15.TryChangeUnknownToAbsent({v103})) {
        if (find_99(v103)) {
          if (const auto ins6 = __15.TryChangeAbsentToPresent({v103}); ins6.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_25.TryChangeUnknownToAbsent({v114, v115})) {
        if (find_117(v114, v115)) {
          if (const auto ins7 = table_25.TryChangeAbsentToPresent({v114, v115}); ins7.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_18.State({v123})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v123})) {
        if (find_125(v123)) {
          if (const auto ins8 = table_18.TryChangeAbsentToPresent({v123}); ins8.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_128(int32_t v129) {
  switch (table_18.State({v129})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v129})) {
        if (find_125(v129)) {
          if (const auto ins9 = table_18.TryChangeAbsentToPresent({v129}); ins9.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_5.State({v134})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v134})) {
        if (find_139(v134)) {
          if (const auto ins10 = table_5.TryChangeAbsentToPresent({v134}); ins10.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_142(int32_t v143) {
  switch (table_5.State({v143})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v143})) {
        if (find_139(v143)) {
          if (const auto ins11 = table_5.TryChangeAbsentToPresent({v143}); ins11.changed) {
            return true;
          }
        } else {
          return false;
      ...
      if (const uint32_t j49_1 = table_5.Find({v50}); j49_1 != ::hyde::rt::kNoRow) {
        ...
        if (v50 == v51 && v50 == v52) {
          switch (table_5.State({v52})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins12 = table_18.TryChangeAbsentOrUnknownToPresent({v52}); ins12.changed) {
                if (const auto ins13 = table_25.TryChangeAbsentOrUnknownToPresent({true, v52}); ins13.changed) {
                  if (const auto ins14 = __15.TryChangeAbsentOrUnknownToPresent({true}); ins14.changed) {
                    vec37.Add({true});
                  }
                }
              }
      ...
      for (uint32_t j53_1 = idx_45.First({v54}); j53_1 != ::hyde::rt::kNoRow; j53_1 = idx_45.Next(j53_1)) {
        ...
        if (v54 == v55 && v54 == v56) {
          switch (__15.State({v55})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins15 = table_21.TryChangeAbsentOrUnknownToPresent({v55, v57}); ins15.changed) {
                if (ins15.added_row) {
                  idx_79.Add({v57}, ins15.id);
                }
                if (const auto ins16 = user_is_logged_in_29.TryChangeAbsentOrUnknownToPresent({v57}); ins16.changed) {
                }
              }
              break;
            }
