...
class Database {
 ...
 private:
  ...
  bool flow_300(::hyde::rt::Vec<Tup_i32> vec65, ::hyde::rt::Vec<Tup_b> vec67, ::hyde::rt::Vec<Tup_i32> vec69, ::hyde::rt::Vec<Tup_i32> vec85, ::hyde::rt::Vec<Tup_b> vec87, ::hyde::rt::Vec<Tup_i32> vec89, ::hyde::rt::Vec<Tup_i32> vec105, ::hyde::rt::Vec<Tup_i32> vec108, ::hyde::rt::Vec<Tup_b> vec110);
