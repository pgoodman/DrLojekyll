...
bool Database::proc_59(::hyde::rt::Vec<Tup_i32> vec61, ::hyde::rt::Vec<Tup_i32_i32> vec73, ::hyde::rt::Vec<Tup_i32> vec78, ::hyde::rt::Vec<Tup_i32> vec82, ::hyde::rt::Vec<Tup_i32_i32> vec93, ::hyde::rt::Vec<Tup_i32> vec98, ::hyde::rt::Vec<Tup_i32> vec102, ::hyde::rt::Vec<Tup_i32_i32> vec113, ::hyde::rt::Vec<Tup_i32> vec118) {
  ...
  ::hyde::rt::Vec<Tup_b> vec87(allocator);
  ...
  vec113.Clear();
  vec118.Clear();
  flow_300(std::move(vec65), std::move(vec67), std::move(vec69), std::move(vec85), std::move(vec87), std::move(vec89), std::move(vec105), std::move(vec108), std::move(vec110));
  return false;
}
...
bool Database::flow_300(::hyde::rt::Vec<Tup_i32> vec65, ::hyde::rt::Vec<Tup_b> vec67, ::hyde::rt::Vec<Tup_i32> vec69, ::hyde::rt::Vec<Tup_i32> vec85, ::hyde::rt::Vec<Tup_b> vec87, ::hyde::rt::Vec<Tup_i32> vec89, ::hyde::rt::Vec<Tup_i32> vec105, ::hyde::rt::Vec<Tup_i32> vec108, ::hyde::rt::Vec<Tup_b> vec110) {
  ...
  ::hyde::rt::Vec<Tup_b> vec88(allocator);
  ...
  for (bool reenter64 = true; reenter64; ) {
    for (bool changed64 = true; changed64; changed64 = !(true && vec65.Empty() && vec67.Empty() && vec69.Empty() && vec85.Empty() && vec87.Empty() && vec89.Empty() && vec105.Empty() && vec108.Empty() && vec110.Empty())) {
      vec66.Clear();
      vec65.SortAndUnique();
      vec65.Swap(vec66);
      for (auto [v168] : vec66) {
        if (const uint32_t j167_0 = t1_out_26.Find({v168}); j167_0 != ::hyde::rt::kNoRow) {
          ...
          for (uint32_t j167_1 = idx_169.First({v168}); j167_1 != ::hyde::rt::kNoRow; j167_1 = idx_169.Next(j167_1)) {
            ...
            if (v168 == v170 && v168 == v171) {
              if (const auto ins12 = table_39.TryChangeAbsentToPresent({v172, true}); ins12.changed) {
                if (ins12.added_row) {
                  idx_187.Add({true}, ins12.id);
                }
        ...
        if (const uint32_t j185_0 = c1_5.Find({v186}); j185_0 != ::hyde::rt::kNoRow) {
          ...
          for (uint32_t j185_1 = idx_187.First({v186}); j185_1 != ::hyde::rt::kNoRow; j185_1 = idx_187.Next(j185_1)) {
            ...
            if (v186 == v188 && v186 == v189) {
              if (const auto ins13 = t1_out_26.TryChangeAbsentToPresent({v190}); ins13.changed) {
        ...
        if (const uint32_t j161_0 = t2_out_29.Find({v162}); j161_0 != ::hyde::rt::kNoRow) {
          ...
          for (uint32_t j161_1 = idx_163.First({v162}); j161_1 != ::hyde::rt::kNoRow; j161_1 = idx_163.Next(j161_1)) {
            ...
            if (v162 == v164 && v162 == v165) {
              if (const auto ins14 = table_47.TryChangeAbsentToPresent({v166, true}); ins14.changed) {
                if (ins14.added_row) {
        ...
        if (const uint32_t j179_0 = c2_12.Find({v180}); j179_0 != ::hyde::rt::kNoRow) {
          ...
          for (uint32_t j179_1 = idx_181.First({v180}); j179_1 != ::hyde::rt::kNoRow; j179_1 = idx_181.Next(j179_1)) {
            ...
            if (v180 == v182 && v180 == v183) {
              if (const auto ins15 = t2_out_29.TryChangeAbsentToPresent({v184}); ins15.changed) {
        ...
        if (const uint32_t j155_0 = t3_out_32.Find({v156}); j155_0 != ::hyde::rt::kNoRow) {
          ...
          for (uint32_t j155_1 = idx_157.First({v156}); j155_1 != ::hyde::rt::kNoRow; j155_1 = idx_157.Next(j155_1)) {
            ...
            if (v156 == v158 && v156 == v159) {
              if (const auto ins16 = table_55.TryChangeAbsentToPresent({v160, true}); ins16.changed) {
                if (ins16.added_row) {
        ...
        if (const uint32_t j173_0 = c3_19.Find({v174}); j173_0 != ::hyde::rt::kNoRow) {
          ...
          for (uint32_t j173_1 = idx_175.First({v174}); j173_1 != ::hyde::rt::kNoRow; j173_1 = idx_175.Next(j173_1)) {
            ...
            if (v174 == v176 && v174 == v177) {
              if (const auto ins17 = t3_out_32.TryChangeAbsentToPresent({v178}); ins17.changed) {
    ...
    vec91.Clear();
    vec71.Clear();
    reenter64 = !(true && vec65.Empty() && vec67.Empty() && vec69.Empty() && vec85.Empty() && vec87.Empty() && vec89.Empty() && vec105.Empty() && vec108.Empty() && vec110.Empty());
  }
  return true;
}
