...
class Database {
 ...
 private:
  bool init_4();
  bool proc_59(::hyde::rt::Vec<Tup_i32> vec61, ::hyde::rt::Vec<Tup_i32_i32> vec73, ::hyde::rt::Vec<Tup_i32> vec78, ::hyde::rt::Vec<Tup_i32> vec82, ::hyde::rt::Vec<Tup_i32_i32> vec93, ::hyde::rt::Vec<Tup_i32> vec98, ::hyde::rt::Vec<Tup_i32> vec102, ::hyde::rt::Vec<Tup_i32_i32> vec113, ::hyde::rt::Vec<Tup_i32> vec118);
  bool flow_300(::hyde::rt::Vec<Tup_i32> vec65, ::hyde::rt::Vec<Tup_b> vec68, ::hyde::rt::Vec<Tup_i32> vec70, ::hyde::rt::Vec<Tup_i32> vec85, ::hyde::rt::Vec<Tup_i32> vec88, ::hyde::rt::Vec<Tup_b> vec90, ::hyde::rt::Vec<Tup_i32> vec105, ::hyde::rt::Vec<Tup_i32> vec108, ::hyde::rt::Vec<Tup_b> vec110);
