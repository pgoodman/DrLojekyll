                ...
                if (true == v54) {
                  if (table_24.TryChangePresentToUnknown({true, v53})) {
                    if (table_28.TryChangePresentToUnknown({v53})) {
                      user_is_logged_in_35.TryChangePresentToUnknown({v53});
                    }
                  }
                }
              }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_24.TryChangeUnknownToAbsent({v104, v105})) {
        if (find_107(v104, v105)) {
          if (const auto ins6 = table_24.TryChangeAbsentToPresent({v104, v105}); ins6.changed) {
            if (ins6.added_row) {
              idx_99.Add({v105}, ins6.id);
            }
            return true;
          }
        } else {
  ...
  switch (__15.State({v117})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__15.TryChangeUnknownToAbsent({v117})) {
        if (find_119(v117)) {
          if (const auto ins7 = __15.TryChangeAbsentToPresent({v117}); ins7.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_31.TryChangeUnknownToAbsent({v134, v135})) {
        if (find_137(v134, v135)) {
          if (const auto ins8 = table_31.TryChangeAbsentToPresent({v134, v135}); ins8.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_21.State({v147})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_21.TryChangeUnknownToAbsent({v147})) {
        if (find_149(v147)) {
          if (const auto ins9 = table_21.TryChangeAbsentToPresent({v147}); ins9.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_5.State({v158})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v158})) {
        if (find_163(v158)) {
          if (const auto ins10 = table_5.TryChangeAbsentToPresent({v158}); ins10.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_5.State({v167})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v167})) {
        if (find_169(v167)) {
          if (const auto ins11 = table_5.TryChangeAbsentToPresent({v167}); ins11.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_18.State({v174})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v174})) {
        if (find_176(v174)) {
          if (const auto ins12 = table_18.TryChangeAbsentToPresent({v174}); ins12.changed) {
            return true;
          }
        } else {
          return false;
      ...
      if (const uint32_t j55_1 = table_5.Find({v56}); j55_1 != ::hyde::rt::kNoRow) {
        ...
        if (v56 == v57 && v56 == v58) {
          switch (table_5.State({v58})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins13 = table_21.TryChangeAbsentOrUnknownToPresent({v58}); ins13.changed) {
                if (const auto ins14 = table_31.TryChangeAbsentOrUnknownToPresent({true, v58}); ins14.changed) {
                  if (const auto ins15 = __15.TryChangeAbsentOrUnknownToPresent({true}); ins15.changed) {
                    vec43.Add({true});
                  }
                }
              }
      ...
      for (uint32_t j59_1 = idx_51.First({v60}); j59_1 != ::hyde::rt::kNoRow; j59_1 = idx_51.Next(j59_1)) {
        ...
        if (v60 == v61 && v60 == v62) {
          switch (__15.State({v61})) {
            case ::hyde::rt::TupleState::kPresent: {
              if (const auto ins16 = table_24.TryChangeAbsentOrUnknownToPresent({v61, v63}); ins16.changed) {
                if (ins16.added_row) {
                  idx_99.Add({v63}, ins16.id);
                }
                if (const auto ins17 = table_28.TryChangeAbsentOrUnknownToPresent({v63}); ins17.changed) {
                  user_is_logged_in_35.TryChangeAbsentOrUnknownToPresent({v63});
                }
              }
              break;
            }
