...
bool Database::proc_52(::hyde::rt::Vec<Tup_i32> vec54, ::hyde::rt::Vec<Tup_i32> vec55, ::hyde::rt::Vec<Tup_i32> vec80, ::hyde::rt::Vec<Tup_i32> vec81) {
                ...
                if (find_62(v60, v61)) {
                  if (table_28.TryChangePresentToUnknown({v61, v60})) {
                    if (table_35.TryChangePresentToUnknown({v60})) {
                      if (ungated_45.TryChangePresentToUnknown({v60})) {
                      }
                    }
                  }
                }
                  ...
                  if (!find_73(v71)) {
                    if (const auto ins4 = table_28.TryChangeAbsentOrUnknownToPresent({v71, v70}); ins4.changed) {
                      ...
                      if (const auto ins5 = table_35.TryChangeAbsentOrUnknownToPresent({v70}); ins5.changed) {
                        if (const auto ins6 = ungated_45.TryChangeAbsentOrUnknownToPresent({v70}); ins6.changed) {
                        }
                      }
                    }
                  }
              ...
              if (true == v79) {
                if (table_24.TryChangePresentToUnknown({true, v78})) {
                  if (table_32.TryChangePresentToUnknown({v78})) {
                    if (gated_42.TryChangePresentToUnknown({v78})) {
                    }
                  }
                }
              }
  ...
  for (auto [v83] : vec80) {
    if (const auto ins7 = table_15.TryChangeAbsentToPresent({v83}); ins7.changed) {
      if (const auto ins8 = table_21.TryChangeAbsentOrUnknownToPresent({v83}); ins8.changed) {
        if (const auto ins9 = table_5.TryChangeAbsentOrUnknownToPresent({v83, true}); ins9.changed) {
          if (ins9.added_row) {
            idx_76.Add({true}, ins9.id);
          }
          vec66.Add({true});
        }
        if (const auto ins10 = table_48.TryChangeAbsentOrUnknownToPresent({v83, true}); ins10.changed) {
          if (ins10.added_row) {
            idx_58.Add({true}, ins10.id);
          }
          if (!find_73(true)) {
            if (const auto ins11 = table_28.TryChangeAbsentOrUnknownToPresent({true, v83}); ins11.changed) {
              if (ins11.added_row) {
                idx_130.Add({v83}, ins11.id);
              }
              if (const auto ins12 = table_35.TryChangeAbsentOrUnknownToPresent({v83}); ins12.changed) {
                if (const auto ins13 = ungated_45.TryChangeAbsentOrUnknownToPresent({v83}); ins13.changed) {
                }
              }
            }
          }
        ...
        if (table_5.TryChangePresentToUnknown({v86, true})) {
          if (table_24.TryChangePresentToUnknown({true, v86})) {
            if (table_32.TryChangePresentToUnknown({v86})) {
              if (gated_42.TryChangePresentToUnknown({v86})) {
              }
            }
          }
        }
        if (table_48.TryChangePresentToUnknown({v86, true})) {
          if (table_28.TryChangePresentToUnknown({true, v86})) {
            if (table_35.TryChangePresentToUnknown({v86})) {
              if (ungated_45.TryChangePresentToUnknown({v86})) {
              }
            }
          }
        }
  ...
  switch (table_48.State({v63, v64})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_48.TryChangeUnknownToAbsent({v63, v64})) {
        if (find_148(v63, v64)) {
          if (const auto ins14 = table_48.TryChangeAbsentToPresent({v63, v64}); ins14.changed) {
            if (ins14.added_row) {
              idx_58.Add({v64}, ins14.id);
            }
            return true;
          }
        } else {
  ...
  switch (__9.State({v74})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v74})) {
        if (find_304(v74)) {
          if (const auto ins15 = __9.TryChangeAbsentToPresent({v74}); ins15.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (gated_42.State({v106})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (gated_42.TryChangeUnknownToAbsent({v106})) {
        if (find_187(v106)) {
          if (const auto ins16 = gated_42.TryChangeAbsentToPresent({v106}); ins16.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (ungated_45.State({v108})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (ungated_45.TryChangeUnknownToAbsent({v108})) {
        if (find_109(v108)) {
          if (const auto ins17 = ungated_45.TryChangeAbsentToPresent({v108}); ins17.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_35.State({v114})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_35.TryChangeUnknownToAbsent({v114})) {
        if (find_116(v114)) {
          if (const auto ins18 = table_35.TryChangeAbsentToPresent({v114}); ins18.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_119(int32_t v120) {
  switch (table_35.State({v120})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_35.TryChangeUnknownToAbsent({v120})) {
        if (find_116(v120)) {
          if (const auto ins19 = table_35.TryChangeAbsentToPresent({v120}); ins19.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_28.TryChangeUnknownToAbsent({v135, v136})) {
        if (find_138(v135, v136)) {
          if (const auto ins20 = table_28.TryChangeAbsentToPresent({v135, v136}); ins20.changed) {
            if (ins20.added_row) {
              idx_130.Add({v136}, ins20.id);
            }
            return true;
          }
        } else {
...
bool Database::find_143(int32_t v144, bool v145) {
  switch (table_48.State({v144, v145})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_48.TryChangeUnknownToAbsent({v144, v145})) {
        if (find_148(v144, v145)) {
          if (const auto ins21 = table_48.TryChangeAbsentToPresent({v144, v145}); ins21.changed) {
            if (ins21.added_row) {
              idx_58.Add({v145}, ins21.id);
            }
            return true;
          }
        } else {
  ...
  switch (table_21.State({v154})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_21.TryChangeUnknownToAbsent({v154})) {
        if (find_156(v154)) {
          if (const auto ins22 = table_21.TryChangeAbsentToPresent({v154}); ins22.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_21.State({v160})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_21.TryChangeUnknownToAbsent({v160})) {
        if (find_162(v160)) {
          if (const auto ins23 = table_21.TryChangeAbsentToPresent({v160}); ins23.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_15.State({v167})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_15.TryChangeUnknownToAbsent({v167})) {
        if (find_169(v167)) {
          if (const auto ins24 = table_15.TryChangeAbsentToPresent({v167}); ins24.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_172(int32_t v173) {
  switch (table_15.State({v173})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_15.TryChangeUnknownToAbsent({v173})) {
        if (find_169(v173)) {
          if (const auto ins25 = table_15.TryChangeAbsentToPresent({v173}); ins25.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_32.State({v192})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_32.TryChangeUnknownToAbsent({v192})) {
        if (find_194(v192)) {
          if (const auto ins26 = table_32.TryChangeAbsentToPresent({v192}); ins26.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_197(int32_t v198) {
  switch (table_32.State({v198})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_32.TryChangeUnknownToAbsent({v198})) {
        if (find_194(v198)) {
          if (const auto ins27 = table_32.TryChangeAbsentToPresent({v198}); ins27.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_24.TryChangeUnknownToAbsent({v213, v214})) {
        if (find_216(v213, v214)) {
          if (const auto ins28 = table_24.TryChangeAbsentToPresent({v213, v214}); ins28.changed) {
            if (ins28.added_row) {
              idx_208.Add({v214}, ins28.id);
            }
            return true;
          }
        } else {
  ...
  switch (table_5.State({v222, v223})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v222, v223})) {
        if (find_286(v222, v223)) {
          if (const auto ins29 = table_5.TryChangeAbsentToPresent({v222, v223}); ins29.changed) {
            if (ins29.added_row) {
              idx_76.Add({v223}, ins29.id);
            }
            return true;
          }
        } else {
...
bool Database::find_225(bool v226) {
  switch (__9.State({v226})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v226})) {
        if (find_228(v226)) {
          if (const auto ins30 = __9.TryChangeAbsentToPresent({v226}); ins30.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_231(bool v232) {
  switch (__9.State({v232})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v232})) {
        if (find_228(v232)) {
          if (const auto ins31 = __9.TryChangeAbsentToPresent({v232}); ins31.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_38.TryChangeUnknownToAbsent({v243, v244})) {
        if (find_246(v243, v244)) {
          if (const auto ins32 = table_38.TryChangeAbsentToPresent({v243, v244}); ins32.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_18.State({v256})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v256})) {
        if (find_258(v256)) {
          if (const auto ins33 = table_18.TryChangeAbsentToPresent({v256}); ins33.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_18.State({v262})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v262})) {
        if (find_264(v262)) {
          if (const auto ins34 = table_18.TryChangeAbsentToPresent({v262}); ins34.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_12.State({v269})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_12.TryChangeUnknownToAbsent({v269})) {
        if (find_271(v269)) {
          if (const auto ins35 = table_12.TryChangeAbsentToPresent({v269}); ins35.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_271(int32_t v272) {
  if (find_279(v272)) {
    return true;
  } else {
    return false;
...
bool Database::find_274(int32_t v275) {
  switch (table_12.State({v275})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_12.TryChangeUnknownToAbsent({v275})) {
        if (find_271(v275)) {
          if (const auto ins36 = table_12.TryChangeAbsentToPresent({v275}); ins36.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_279(int32_t v280) {
  if (find_282(v280)) {
    return true;
  } else {
    return false;
...
bool Database::find_282(int32_t v283) {
  return false;
}
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v291, v292})) {
        if (find_286(v291, v292)) {
          if (const auto ins37 = table_5.TryChangeAbsentToPresent({v291, v292}); ins37.changed) {
            if (ins37.added_row) {
              idx_76.Add({v292}, ins37.id);
            }
            return true;
          }
        } else {
...
bool Database::find_296(int32_t v297) {
  switch (table_21.State({v297})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_21.TryChangeUnknownToAbsent({v297})) {
        if (find_299(v297)) {
          if (const auto ins38 = table_21.TryChangeAbsentToPresent({v297}); ins38.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_299(int32_t v300) {
  if (find_183(v300)) {
    return true;
  } else {
    return false;
...
bool Database::find_304(bool v305) {
  if (find_236(v305)) {
    return true;
  } else {
    return false;
          ...
          switch (table_5.State({v91, v89})) {
            case ::hyde::rt::TupleState::kPresent: {
              switch (__9.State({v89})) {
                case ::hyde::rt::TupleState::kPresent: {
                  if (const auto ins39 = table_24.TryChangeAbsentOrUnknownToPresent({v89, v91}); ins39.changed) {
                    if (ins39.added_row) {
                      idx_208.Add({v91}, ins39.id);
                    }
                    if (const auto ins40 = table_32.TryChangeAbsentOrUnknownToPresent({v91}); ins40.changed) {
                      if (const auto ins41 = gated_42.TryChangeAbsentOrUnknownToPresent({v91}); ins41.changed) {
                      }
                    }
                  }
                  break;
