...
class Database {
 ...
 private:
  ...
  bool find_143(int32_t v144, bool v145);
  ...
  bool find_225(bool v226);
  bool find_228(bool v229);
  bool find_231(bool v232);
  ...
  bool find_271(int32_t v272);
  bool find_274(int32_t v275);
  bool find_279(int32_t v280);
  bool find_282(int32_t v283);
  bool find_286(int32_t v287, bool v288);
  bool find_290(int32_t v291, bool v292);
  bool find_296(int32_t v297);
  bool find_299(int32_t v300);
  bool find_304(bool v305);
