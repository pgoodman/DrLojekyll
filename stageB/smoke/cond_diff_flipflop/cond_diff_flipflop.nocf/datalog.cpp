...
bool Database::proc_36(::hyde::rt::Vec<Tup_i32> vec38, ::hyde::rt::Vec<Tup_i32> vec39, ::hyde::rt::Vec<Tup_i32> vec60, ::hyde::rt::Vec<Tup_i32> vec61) {
          ...
          for (uint32_t s42 = 0; s42 < table_12.NumRows(); ++s42) {
            ...
            if (find_44(v43)) {
              if (table_22.TryChangePresentToUnknown({true, v43})) {
                if (ungated_33.TryChangePresentToUnknown({v43})) {
                }
              }
            }
          }
            ...
            if (find_44(v51)) {
              if (!find_53(true)) {
                if (const auto ins3 = table_22.TryChangeAbsentOrUnknownToPresent({true, v51}); ins3.changed) {
                  ...
                  if (const auto ins4 = ungated_33.TryChangeAbsentOrUnknownToPresent({v51}); ins4.changed) {
                  }
                }
              }
            }
          ...
          for (uint32_t s57 = idx_56.First({true}); s57 != ::hyde::rt::kNoRow; s57 = idx_56.Next(s57)) {
            ...
            if (true == v59) {
              if (table_18.TryChangePresentToUnknown({true, v58})) {
                if (gated_30.TryChangePresentToUnknown({v58})) {
                }
              }
            }
          }
  ...
  for (auto [v63] : vec60) {
    if (const auto ins5 = table_12.TryChangeAbsentToPresent({v63}); ins5.changed) {
      if (!find_53(true)) {
        if (const auto ins6 = table_22.TryChangeAbsentOrUnknownToPresent({true, v63}); ins6.changed) {
          if (ins6.added_row) {
            idx_96.Add({v63}, ins6.id);
          }
          if (const auto ins7 = ungated_33.TryChangeAbsentOrUnknownToPresent({v63}); ins7.changed) {
          }
        }
      }
      if (const auto ins8 = table_5.TryChangeAbsentOrUnknownToPresent({v63, true}); ins8.changed) {
        if (ins8.added_row) {
          idx_56.Add({true}, ins8.id);
        }
        vec47.Add({true});
      }
    }
  ...
  switch (table_12.State({v45})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_12.TryChangeUnknownToAbsent({v45})) {
        if (find_113(v45)) {
          if (const auto ins9 = table_12.TryChangeAbsentToPresent({v45}); ins9.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (__9.State({v54})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v54})) {
        if (find_193(v54)) {
          if (const auto ins10 = __9.TryChangeAbsentToPresent({v54}); ins10.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (gated_30.State({v86})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (gated_30.TryChangeUnknownToAbsent({v86})) {
        if (find_117(v86)) {
          if (const auto ins11 = gated_30.TryChangeAbsentToPresent({v86}); ins11.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (ungated_33.State({v88})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (ungated_33.TryChangeUnknownToAbsent({v88})) {
        if (find_89(v88)) {
          if (const auto ins12 = ungated_33.TryChangeAbsentToPresent({v88}); ins12.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_22.TryChangeUnknownToAbsent({v101, v102})) {
        if (find_104(v101, v102)) {
          if (const auto ins13 = table_22.TryChangeAbsentToPresent({v101, v102}); ins13.changed) {
            if (ins13.added_row) {
              idx_96.Add({v102}, ins13.id);
            }
            return true;
          }
        } else {
...
bool Database::find_109(int32_t v110) {
  switch (table_12.State({v110})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_12.TryChangeUnknownToAbsent({v110})) {
        if (find_113(v110)) {
          if (const auto ins14 = table_12.TryChangeAbsentToPresent({v110}); ins14.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_18.TryChangeUnknownToAbsent({v129, v130})) {
        if (find_132(v129, v130)) {
          if (const auto ins15 = table_18.TryChangeAbsentToPresent({v129, v130}); ins15.changed) {
            if (ins15.added_row) {
              idx_124.Add({v130}, ins15.id);
            }
            return true;
          }
        } else {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v138, v139})) {
        if (find_178(v138, v139)) {
          if (const auto ins16 = table_5.TryChangeAbsentToPresent({v138, v139}); ins16.changed) {
            if (ins16.added_row) {
              idx_56.Add({v139}, ins16.id);
            }
            return true;
          }
        } else {
...
bool Database::find_141(bool v142) {
  switch (__9.State({v142})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v142})) {
        if (find_144(v142)) {
          if (const auto ins17 = __9.TryChangeAbsentToPresent({v142}); ins17.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_147(bool v148) {
  switch (__9.State({v148})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (__9.TryChangeUnknownToAbsent({v148})) {
        if (find_144(v148)) {
          if (const auto ins18 = __9.TryChangeAbsentToPresent({v148}); ins18.changed) {
            return true;
          }
        } else {
          return false;
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_26.TryChangeUnknownToAbsent({v159, v160})) {
        if (find_162(v159, v160)) {
          if (const auto ins19 = table_26.TryChangeAbsentToPresent({v159, v160}); ins19.changed) {
            return true;
          }
        } else {
          return false;
  ...
  switch (table_15.State({v168})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_15.TryChangeUnknownToAbsent({v168})) {
        if (find_170(v168)) {
          if (const auto ins20 = table_15.TryChangeAbsentToPresent({v168}); ins20.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_173(int32_t v174) {
  switch (table_15.State({v174})) {
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_15.TryChangeUnknownToAbsent({v174})) {
        if (find_170(v174)) {
          if (const auto ins21 = table_15.TryChangeAbsentToPresent({v174}); ins21.changed) {
            return true;
          }
        } else {
          return false;
...
bool Database::find_182(int32_t v183, bool v184) {
  switch (table_5.State({v183, v184})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_5.TryChangeUnknownToAbsent({v183, v184})) {
        if (find_178(v183, v184)) {
          if (const auto ins22 = table_5.TryChangeAbsentToPresent({v183, v184}); ins22.changed) {
            if (ins22.added_row) {
              idx_56.Add({v184}, ins22.id);
            }
            return true;
          }
        } else {
...
bool Database::find_188(int32_t v189) {
  switch (table_12.State({v189})) {
    case ::hyde::rt::TupleState::kPresent: {
      return true;
      break;
    }
    ...
    case ::hyde::rt::TupleState::kUnknown: {
      if (table_12.TryChangeUnknownToAbsent({v189})) {
        if (find_113(v189)) {
          if (const auto ins23 = table_12.TryChangeAbsentToPresent({v189}); ins23.changed) {
            return true;
          }
        } else {
          return false;
          ...
          switch (table_5.State({v71, v69})) {
            case ::hyde::rt::TupleState::kPresent: {
              switch (__9.State({v69})) {
                case ::hyde::rt::TupleState::kPresent: {
                  if (const auto ins24 = table_18.TryChangeAbsentOrUnknownToPresent({v69, v71}); ins24.changed) {
                    if (ins24.added_row) {
                      idx_124.Add({v71}, ins24.id);
                    }
                    if (const auto ins25 = gated_30.TryChangeAbsentOrUnknownToPresent({v71}); ins25.changed) {
                    }
                  }
                  break;
                }
